...
function FAB({
  ...
  const content = /* @__PURE__ */ jsx11(AnimatePresence3, {
    initial: false,
    children: !(stateOnScroll === "disappear" && canHide && scrollDir === "down") && /* @__PURE__ */ jsxs8(motion7.div, {
      ref: fabRef,
      ...
      children: [
        icon && /* @__PURE__ */ jsx11("div", {
          className: "skc-fab__icon",
          children: icon
        }),
        !(stateOnScroll === "minimize" && !(scrollDir === "up")) && children && /* @__PURE__ */ jsx11("span", {
  ...
  return href && Element ? /* @__PURE__ */ jsx11(Element, {
    ...props,
    href,
    children: content
  }) : href ? /* @__PURE__ */ jsx11("a", {
    href,
    ...props,
    children: content
