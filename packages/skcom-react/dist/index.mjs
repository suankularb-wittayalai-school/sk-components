...
function Card({
  ...
  const content = /* @__PURE__ */ jsxs3(Fragment2, { children: [
    children,
    stateLayerEffect && /* @__PURE__ */ jsx6(
      motion4.span,
      {
        initial: { scale: 0, opacity: 0.36 },
        animate: rippleControls,
  ...
  return (
    // Render with `element` if defined
    href && Element ? /* @__PURE__ */ jsx6(Element, __spreadProps(__spreadValues({}, props), { href, children: content })) : (
      // Render an `<a>` if link passed in
      href ? layoutID ? /* @__PURE__ */ jsx6(motion4.a, __spreadProps(__spreadValues({}, props), { layoutId: layoutID, children: content })) : /* @__PURE__ */ jsx6("a", __spreadProps(__spreadValues({}, props), { href, children: content })) : (
        // Render a `<button>` if `onClick` passed in
        onClick ? layoutID ? /* @__PURE__ */ jsx6(
          motion4.button,
        ...
        ) : /* @__PURE__ */ jsx6("button", __spreadProps(__spreadValues({}, __spreadProps(__spreadValues({}, props), { onClick })), { type: "button", children: content })) : (
          // Otherwise, render a `<div>`
          layoutID ? /* @__PURE__ */ jsx6(motion4.div, __spreadProps(__spreadValues({}, props), { layoutId: layoutID, children: content })) : /* @__PURE__ */ jsx6("div", __spreadProps(__spreadValues({}, props), { children: content }))
        )
      )
    )
  );
...
function CardHeader({
  ...
  return /* @__PURE__ */ jsxs4("div", { style, className: cn(["skc-card-header", className]), children: [
    avatar && /* @__PURE__ */ jsx7("div", { className: "skc-card-header__avatar", children: avatar }),
    icon && /* @__PURE__ */ jsx7("div", { className: "skc-card-header__icon", children: icon }),
    /* @__PURE__ */ jsxs4("div", { className: "skc-card-header__content", children: [
      /* @__PURE__ */ jsx7("h3", { className: "skc-card-header__title", children: title }),
      subtitle && /* @__PURE__ */ jsx7("span", { className: "skc-card-header__subtitle", children: subtitle })
    ] }),
    overflow && /* @__PURE__ */ jsxs4("div", { className: "skc-card-header__overflow", children: [
      /* @__PURE__ */ jsx7(
        ...
        {
          appearance: "text",
          icon: /* @__PURE__ */ jsx7(MaterialIcon, { icon: "more_vert" }),
...
function CardContent({ children, style, className }) {
  return /* @__PURE__ */ jsx8("div", { style, className: cn(["skc-card-content", className]), children });
}
...
function AssistChip({
  ...
  const content = /* @__PURE__ */ jsxs5(Fragment3, { children: [
    icon && /* @__PURE__ */ jsx10("div", { className: "skc-assist-chip__icon", children: icon }),
    /* @__PURE__ */ jsx10("span", { className: "skc-assist-chip__label", children }),
    /* @__PURE__ */ jsx10(
      motion5.span,
      {
        initial: { scale: 0, opacity: 0.36 },
  ...
  return (
    // Render with `element` if defined
    href && Element ? /* @__PURE__ */ jsx10(Element, __spreadProps(__spreadValues({}, props), { href, children: content })) : (
      // Render an `<a>` if link passed in
      href ? /* @__PURE__ */ jsx10("a", __spreadProps(__spreadValues({}, props), { href, children: content })) : (
        // Otherwise, render a `<button>`
        /* @__PURE__ */ jsx10("button", __spreadProps(__spreadValues({}, props), { type: "button", children: content }))
      )
    )
  );
}
...
function Divider({ style, className }) {
  return /* @__PURE__ */ jsx15("hr", { style, className: cn(["skc-divider", className]) });
}
...
function Header({
  ...
  const content = /* @__PURE__ */ jsxs9(Fragment6, { children: [
    icon && /* @__PURE__ */ jsx16("span", { className: "skc-header__icon", children: icon }),
    /* @__PURE__ */ jsx16("span", { className: "skc-header__text", children })
  ] });
  return level === 6 ? /* @__PURE__ */ jsx16("h6", __spreadProps(__spreadValues({}, props), { children: content })) : level === 5 ? /* @__PURE__ */ jsx16("h5", __spreadProps(__spreadValues({}, props), { children: content })) : level === 4 ? /* @__PURE__ */ jsx16("h4", __spreadProps(__spreadValues({}, props), { children: content })) : level === 3 ? /* @__PURE__ */ jsx16("h3", __spreadProps(__spreadValues({}, props), { children: content })) : /* @__PURE__ */ jsx16("h2", __spreadProps(__spreadValues({}, props), { children: content }));
}
...
function List({
  ...
  return /* @__PURE__ */ jsx17(
    "ul",
    {
      ...
      children: columns ? /* @__PURE__ */ jsx17(Columns, { columns, children }) : children
    }
  );
}
...
function ListItem({
  ...
  const content = /* @__PURE__ */ jsxs10(Fragment7, { children: [
    children,
    stateLayerEffect && /* @__PURE__ */ jsx18(
      motion8.span,
      {
        initial: { scale: 0, opacity: 0.36 },
        animate: rippleControls,
  ...
  return (
    ...
    href || onClick || stateLayerEffect ? /* @__PURE__ */ jsx18("li", {
      "aria-labelledby": itemID,
      // Render with `element` if defined
      children: href && Element ? /* @__PURE__ */ jsx18(Element, __spreadProps(__spreadValues({}, props), { href, children: content })) : (
        // Render an `<a>` if link passed in
        href ? /* @__PURE__ */ jsx18("a", __spreadProps(__spreadValues({}, props), { href, children: content })) : (
          // Otherwise, render a `<button>`
          /* @__PURE__ */ jsx18("button", __spreadProps(__spreadValues({}, __spreadProps(__spreadValues({}, props), { onClick })), { type: "button", children: content }))
        )
      )
    }) : (
      // If this Item has no functionality, just render a `<li>`
      /* @__PURE__ */ jsx18("li", __spreadProps(__spreadValues({}, props), { children: content }))
    )
  );
}
...
function ListItemContent({
  ...
  return /* @__PURE__ */ jsxs11("div", { style, className: cn(["skc-list-item-content", className]), children: [
    overline && /* @__PURE__ */ jsx19("span", { className: "skc-list-item-content__overline", children: overline }),
    /* @__PURE__ */ jsx19(
      "span",
      {
    ...
    desc && /* @__PURE__ */ jsx19("span", { className: "skc-list-item-content__desc", children: desc })
  ] });
}
    ...
    /* @__PURE__ */ jsxs12("div", { className: "skc-nav-bar__main", children: [
      /* @__PURE__ */ jsxs12("section", { className: "skc-nav-bar__toggle-and-fab", children: [
        /* @__PURE__ */ jsx20(
          ...
          {
            appearance: "text",
            icon: /* @__PURE__ */ jsx20(MaterialIcon, { icon: "menu" }),
            alt: locale === "th" ? "\u0E40\u0E1B\u0E34\u0E14\u0E40\u0E21\u0E19\u0E39" : "Toggle Navigation Drawer",
            onClick: onNavToggle
          }
        ),
        /* @__PURE__ */ jsx20("div", { className: "skc-nav-bar__brand", children: brand }),
        fab
      ] }),
      /* @__PURE__ */ jsx20("section", { className: "skc-nav-bar__destinations", children })
    ] }),
    /* @__PURE__ */ jsx20("section", { className: "skc-nav-bar__end", children: end })
  ] });
}
...
function NavBarItem({
  ...
  const content = /* @__PURE__ */ jsxs13(Fragment8, { children: [
    /* @__PURE__ */ jsxs13("div", { ref: iconRef, className: "skc-nav-bar-item__icon", children: [
      icon,
      /* @__PURE__ */ jsx21(LayoutGroup, { children: /* @__PURE__ */ jsx21(AnimatePresence3, { children: badge !== void 0 && /* @__PURE__ */ jsx21(
        motion9.div,
        {
          initial: { scale: 0 },
          animate: { scale: 1 },
    ...
    label && /* @__PURE__ */ jsx21("span", { id: navID, className: "skc-nav-bar-item__label", children: label })
  ] });
  return (
    // Render with `element` if defined
    Element ? /* @__PURE__ */ jsx21(Element, __spreadProps(__spreadValues({}, props), { children: content })) : (
      // Otherwise, render an `<a>`
      /* @__PURE__ */ jsx21("a", __spreadProps(__spreadValues({}, props), { children: content }))
    )
  );
}
...
// src/components/NavDrawer/index.tsx
import { Fragment as Fragment9, jsx as jsx22, jsxs as jsxs14 } from "react/jsx-runtime";
function NavDrawer({
  children,
  open,
  onClose,
  ...
  return /* @__PURE__ */ jsx22(AnimatePresence4, { children: open && /* @__PURE__ */ jsxs14(Fragment9, { children: [
    /* @__PURE__ */ jsx22(
      motion10.aside,
      {
        ...
        children: /* @__PURE__ */ jsx22("nav", { children: injectedChildren })
      }
    ),
    /* @__PURE__ */ jsx22(
      motion10.div,
...
function NavDrawerItem({
  ...
  const content = /* @__PURE__ */ jsxs16(Fragment10, { children: [
    /* @__PURE__ */ jsx24("div", { className: "skc-nav-drawer-item__icon", children: icon }),
    /* @__PURE__ */ jsx24("span", { className: "skc-nav-drawer-item__label", children: label }),
    metadata && /* @__PURE__ */ jsx24("span", { className: "skc-nav-drawer-item__metadata", children: metadata }),
    /* @__PURE__ */ jsx24(
      motion11.span,
      {
        initial: { scale: 0, opacity: 0.36 },
  ...
  return /* @__PURE__ */ jsx24("li", { children: Element ? /* @__PURE__ */ jsx24(Element, __spreadProps(__spreadValues({}, props), { children: content })) : /* @__PURE__ */ jsx24("a", __spreadProps(__spreadValues({}, props), { children: content })) });
}
...
function FAB({
  ...
  const content = /* @__PURE__ */ jsx25(AnimatePresence5, {
    initial: false,
    ...
    children: !(stateOnScroll === "disappear" && canHide && scrollDir === "down") && /* @__PURE__ */ jsxs17(
      motion12.div,
      {
        ...
        children: [
          icon && /* @__PURE__ */ jsx25("div", { className: "skc-fab__icon", children: icon }),
          // Hide the label on scroll if `stateOnScroll` set to `minimize`
          !(stateOnScroll === "minimize" && !(scrollDir === "up")) && children && /* @__PURE__ */ jsx25("span", { className: "skc-fab__label", children }),
          /* @__PURE__ */ jsx25(
            motion12.span,
            {
              initial: { scale: 0, opacity: 0.36 },
  ...
  return (
    // Render with `element` if defined
    href && Element ? /* @__PURE__ */ jsx25(Element, __spreadProps(__spreadValues({}, props), { href, children: content })) : (
      // Render an `<a>` if link passed in
      href ? /* @__PURE__ */ jsx25("a", __spreadProps(__spreadValues({ href }, props), { children: content })) : (
        // Otherwise, render a `<button>`
        /* @__PURE__ */ jsx25("button", __spreadProps(__spreadValues({ type: "button", onClick }, props), { children: content }))
      )
    )
  );
}
...
function ContentLayout({
  ...
  return /* @__PURE__ */ jsx26(
    motion13.main,
    {
      ...
      children: /* @__PURE__ */ jsx26("div", { className: "skc-content-layout__content", children })
    }
  );
}
...
function PageHeader({
  ...
  return /* @__PURE__ */ jsxs19(Fragment11, { children: [
    /* @__PURE__ */ jsx28("div", { className: "skc-page-header__replacement-color" }),
    /* @__PURE__ */ jsx28(
      "div",
      {
    ...
    /* @__PURE__ */ jsx28(LayoutGroup2, { children: /* @__PURE__ */ jsx28(
      motion14.header,
      {
        ref: headerRef,
            ...
            motion14.div,
            {
              ...
              children: [
                /* @__PURE__ */ jsx28(
                  ...
                  {
                    appearance: "text",
                    icon: /* @__PURE__ */ jsx28(MaterialIcon, { icon: "arrow_backward" }),
                ...
                /* @__PURE__ */ jsx28(motion14.h1, __spreadProps(__spreadValues({}, headerTextProps), { children: title })),
                /* @__PURE__ */ jsxs19("div", { className: "skc-page-header__trailing", children: [
                  ...
                  /* @__PURE__ */ jsx28(
                    ...
                    __spreadValues({
                      appearance: "text",
                      icon: brand || /* @__PURE__ */ jsx28(MaterialIcon, { icon: "home" }),
                      href: homeURL,
                      element
                    }, backAttr)
                  ),
...
function TextField({
  ...
  React18.useEffect(() => {
    ...
    trailingControls.start(__spreadProps(__spreadValues({}, orgtrailingAnimState), { transition: labelTransition }));
  }, [minifyLabel]);
  ...
  return /* @__PURE__ */ jsxs20(
    "label",
    {
      ...
      children: [
        ...
        leading && /* @__PURE__ */ jsx30(motion15.div, { className: "skc-text-field__leading", children: leading }),
        behavior === "single-line" ? /* @__PURE__ */ jsx30("input", __spreadValues(__spreadValues({}, inputProps), inputAttr)) : /* @__PURE__ */ jsx30("textarea", __spreadValues({ ref: textareaRef }, inputProps)),
        (canClear || trailing) && /* @__PURE__ */ jsx30(
          motion15.div,
          {
            ...
            children: canClear ? /* @__PURE__ */ jsx30(
              ...
              {
                appearance: "text",
                icon: /* @__PURE__ */ jsx30(MaterialIcon, { icon: "cancel" }),
                onClick: () => onChange && onChange("")
              }
            ) : trailing
          }
        ),
        helperMsg && /* @__PURE__ */ jsx30("span", { id: `${fieldID}-helper`, className: "skc-text-field__helper-msg", children: helperMsg })
      ]
    }
  );
}
...
import { Fragment as Fragment12, jsx as jsx31 } from "react/jsx-runtime";
function ThemeProvider({ children }) {
  return /* @__PURE__ */ jsx31(Fragment12, { children });
}
