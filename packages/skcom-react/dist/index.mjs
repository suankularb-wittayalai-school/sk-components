...
function ListItemContent({
  ...
  return /* @__PURE__ */ jsxs7("div", { style, className: cn(["skc-list-item-content", className]), children: [
...
function NavBar({
  ...
  return /* @__PURE__ */ jsxs8("nav", { style, className: cn(["skc-nav-bar", className]), children: [
    /* @__PURE__ */ jsxs8("div", { className: "skc-nav-bar__main", children: [
      /* @__PURE__ */ jsxs8("section", { className: "skc-nav-bar__toggle-and-fab", children: [
        /* @__PURE__ */ jsx16(
          Button,
          {
            appearance: "text",
...
import { AnimatePresence, LayoutGroup, motion as motion6 } from "framer-motion";
...
function NavBarItem({
  ...
  const { duration, easing } = useAnimationConfig();
  const iconRef = React7.useRef(null);
  const [clientHeight, setClientHeight] = React7.useState(1080);
  React7.useEffect(() => {
  ...
  const content = /* @__PURE__ */ jsxs9(Fragment5, { children: [
    /* @__PURE__ */ jsxs9("div", { ref: iconRef, className: "skc-nav-bar-item__icon", children: [
      icon,
...
function NavDrawer({
  ...
  const injectedChildren = (
    ...
    React8.Children.map(
      children,
      (section) => React8.cloneElement(section, {
        children: (
          ...
          React8.Children.map(
            ...
            (item) => React8.cloneElement(item, { onClick: onClose })
          )
        )
      })
    )
  );
  return /* @__PURE__ */ jsx18(AnimatePresence2, { children: open && /* @__PURE__ */ jsxs10(Fragment6, { children: [
    /* @__PURE__ */ jsx18(
      motion7.aside,
      {
...
function NavDrawerItem({
  ...
  const linkRef = React9.useRef(null);
...
function FAB({
  ...
  const { duration, easing } = useAnimationConfig();
  const fabRef = React11.useRef(null);
  const { rippleListeners, rippleControls, rippleStyle } = useRipple(fabRef);
  const { scrollDir } = useScrollDirection();
  const [canHide, setCanHide] = React11.useState(false);
  React11.useEffect(() => {
    if (stateOnScroll) {
  ...
  const content = /* @__PURE__ */ jsx21(AnimatePresence3, {
    ...
    children: !(stateOnScroll === "disappear" && canHide && scrollDir === "down") && /* @__PURE__ */ jsxs13(
      motion9.div,
      {
        ref: fabRef,
...
function RootLayout({ children, className, style }) {
  ...
  return /* @__PURE__ */ jsxs14("div", { style, className: cn(["skc-root-layout", className]), children: [
...
function PageHeader({
  ...
  const [minimized, setMinimized] = React13.useState(false);
  React13.useEffect(() => {
  ...
  return /* @__PURE__ */ jsxs15(Fragment8, { children: [
    ...
    /* @__PURE__ */ jsx24(LayoutGroup2, { children: /* @__PURE__ */ jsx24(
      motion11.header,
      {
        ...
        children: /* @__PURE__ */ jsxs15("div", { className: "skc-page-header__content", children: [
          ...
          /* @__PURE__ */ jsxs15(
            motion11.div,
            {
              ...
              children: [
                ...
                /* @__PURE__ */ jsx24(motion11.h1, __spreadProps(__spreadValues({}, headerTextProps), { children: title })),
                /* @__PURE__ */ jsxs15("div", { className: "skc-page-header__trailing", children: [
                  homeURL && // Home Button
                  /* @__PURE__ */ jsx24(
                    Button,
                    __spreadValues({
...
function ThemeProvider({ children }) {
  return /* @__PURE__ */ jsx26(Fragment9, { children });
}
