...
function Divider({ style, className }) {
  return /* @__PURE__ */ jsx13("hr", { style, className: cn(["skc-divider", className]) });
}
...
function Header({
  ...
  const content = /* @__PURE__ */ jsxs8(Fragment5, { children: [
    icon && /* @__PURE__ */ jsx14("span", { className: "skc-header__icon", children: icon }),
    /* @__PURE__ */ jsx14("span", { className: "skc-header__text", children })
  ] });
  return level === 6 ? /* @__PURE__ */ jsx14("h6", __spreadProps(__spreadValues({}, props), { children: content })) : level === 5 ? /* @__PURE__ */ jsx14("h5", __spreadProps(__spreadValues({}, props), { children: content })) : level === 4 ? /* @__PURE__ */ jsx14("h4", __spreadProps(__spreadValues({}, props), { children: content })) : level === 3 ? /* @__PURE__ */ jsx14("h3", __spreadProps(__spreadValues({}, props), { children: content })) : /* @__PURE__ */ jsx14("h2", __spreadProps(__spreadValues({}, props), { children: content }));
}
...
function List({
  ...
  return /* @__PURE__ */ jsx15(
    "ul",
    {
      ...
      children: columns ? /* @__PURE__ */ jsx15(Columns, { columns, children }) : children
    }
  );
}
...
function ListItem({
  ...
  const content = /* @__PURE__ */ jsxs9(Fragment6, { children: [
    children,
    stateLayerEffect && /* @__PURE__ */ jsx16(
      motion7.span,
      {
        initial: { scale: 0, opacity: 0.36 },
        animate: rippleControls,
  ...
  return (
    ...
    href || onClick || stateLayerEffect ? /* @__PURE__ */ jsx16("li", {
      "aria-labelledby": itemID,
      // Render with `element` if defined
      children: href && Element ? /* @__PURE__ */ jsx16(Element, __spreadProps(__spreadValues({}, props), { href, children: content })) : (
        // Render an `<a>` if link passed in
        href ? /* @__PURE__ */ jsx16("a", __spreadProps(__spreadValues({}, props), { href, children: content })) : (
          // Otherwise, render a `<button>`
      ...
      /* @__PURE__ */ jsx16("li", __spreadProps(__spreadValues({}, props), { children: content }))
    )
  );
}
...
function ListItemContent({
  ...
  return /* @__PURE__ */ jsxs10("div", { style, className: cn(["skc-list-item-content", className]), children: [
    overline && /* @__PURE__ */ jsx17("span", { className: "skc-list-item-content__overline", children: overline }),
    /* @__PURE__ */ jsx17(
      "span",
      {
    ...
    desc && /* @__PURE__ */ jsx17("span", { className: "skc-list-item-content__desc", children: desc })
  ] });
}
    ...
    /* @__PURE__ */ jsxs11("div", { className: "skc-nav-bar__main", children: [
      /* @__PURE__ */ jsxs11("section", { className: "skc-nav-bar__toggle-and-fab", children: [
        /* @__PURE__ */ jsx18(
          ...
          {
            appearance: "text",
            icon: /* @__PURE__ */ jsx18(MaterialIcon, { icon: "menu" }),
            alt: locale === "th" ? "\u0E40\u0E1B\u0E34\u0E14\u0E40\u0E21\u0E19\u0E39" : "Toggle Navigation Drawer",
            onClick: onNavToggle
          }
        ),
        /* @__PURE__ */ jsx18("div", { className: "skc-nav-bar__brand", children: brand }),
        fab
      ] }),
      /* @__PURE__ */ jsx18("section", { className: "skc-nav-bar__destinations", children })
    ] }),
    /* @__PURE__ */ jsx18("section", { className: "skc-nav-bar__end", children: end })
  ] });
}
...
function NavBarItem({
  ...
  const content = /* @__PURE__ */ jsxs12(Fragment7, { children: [
    /* @__PURE__ */ jsxs12("div", { ref: iconRef, className: "skc-nav-bar-item__icon", children: [
      icon,
      /* @__PURE__ */ jsx19(LayoutGroup, { children: /* @__PURE__ */ jsx19(AnimatePresence2, { children: badge !== void 0 && /* @__PURE__ */ jsx19(
        motion8.div,
        {
          initial: { scale: 0 },
          animate: { scale: 1 },
    ...
    label && /* @__PURE__ */ jsx19("span", { id: navID, className: "skc-nav-bar-item__label", children: label })
  ] });
  return (
    // Render with `element` if defined
    Element ? /* @__PURE__ */ jsx19(Element, __spreadProps(__spreadValues({}, props), { children: content })) : (
      // Otherwise, render an `<a>`
      /* @__PURE__ */ jsx19("a", __spreadProps(__spreadValues({}, props), { children: content }))
    )
  );
}
...
function NavDrawer({
  ...
  return /* @__PURE__ */ jsx20(AnimatePresence3, { children: open && /* @__PURE__ */ jsxs13(Fragment8, { children: [
    /* @__PURE__ */ jsx20(
      motion9.aside,
      {
        ...
        children: /* @__PURE__ */ jsx20("nav", { children: injectedChildren })
      }
    ),
    /* @__PURE__ */ jsx20(
      motion9.div,
...
function NavDrawerItem({
  ...
  const content = /* @__PURE__ */ jsxs15(Fragment9, { children: [
    /* @__PURE__ */ jsx22("div", { className: "skc-nav-drawer-item__icon", children: icon }),
    /* @__PURE__ */ jsx22("span", { className: "skc-nav-drawer-item__label", children: label }),
    metadata && /* @__PURE__ */ jsx22("span", { className: "skc-nav-drawer-item__metadata", children: metadata }),
    /* @__PURE__ */ jsx22(
      motion10.span,
      {
        initial: { scale: 0, opacity: 0.36 },
  ...
  return /* @__PURE__ */ jsx22("li", { children: Element ? /* @__PURE__ */ jsx22(Element, __spreadProps(__spreadValues({}, props), { children: content })) : /* @__PURE__ */ jsx22("a", __spreadProps(__spreadValues({}, props), { children: content })) });
}
...
function FAB({
  ...
  const content = /* @__PURE__ */ jsx23(AnimatePresence4, {
    initial: false,
    ...
    children: !(stateOnScroll === "disappear" && canHide && scrollDir === "down") && /* @__PURE__ */ jsxs16(
      motion11.div,
      {
        ...
        children: [
          icon && /* @__PURE__ */ jsx23("div", { className: "skc-fab__icon", children: icon }),
          // Hide the label on scroll if `stateOnScroll` set to `minimize`
          !(stateOnScroll === "minimize" && !(scrollDir === "up")) && children && /* @__PURE__ */ jsx23("span", { className: "skc-fab__label", children }),
          /* @__PURE__ */ jsx23(
            motion11.span,
            {
              initial: { scale: 0, opacity: 0.36 },
  ...
  return (
    // Render with `element` if defined
    href && Element ? /* @__PURE__ */ jsx23(Element, __spreadProps(__spreadValues({}, props), { href, children: content })) : (
      // Render an `<a>` if link passed in
      href ? /* @__PURE__ */ jsx23("a", __spreadProps(__spreadValues({ href }, props), { children: content })) : (
        // Otherwise, render a `<button>`
        /* @__PURE__ */ jsx23("button", __spreadProps(__spreadValues({ type: "button", onClick }, props), { children: content }))
      )
    )
  );
}
...
function ContentLayout({
  ...
  return /* @__PURE__ */ jsx24(
    motion12.main,
    {
      ...
      children: /* @__PURE__ */ jsx24("div", { className: "skc-content-layout__content", children })
    }
  );
}
...
function PageHeader({
  ...
  return /* @__PURE__ */ jsxs18(Fragment10, { children: [
    /* @__PURE__ */ jsx26("div", { className: "skc-page-header__replacement-color" }),
    /* @__PURE__ */ jsx26(
      "div",
      {
    ...
    /* @__PURE__ */ jsx26(LayoutGroup2, { children: /* @__PURE__ */ jsx26(
      motion13.header,
      {
        ref: headerRef,
            ...
            motion13.div,
            {
              ...
              children: [
                /* @__PURE__ */ jsx26(
                  ...
                  {
                    appearance: "text",
                    icon: /* @__PURE__ */ jsx26(MaterialIcon, { icon: "arrow_backward" }),
                    onClick: onBack,
                    href: parentURL,
                    element,
                ...
                /* @__PURE__ */ jsx26(motion13.h1, __spreadProps(__spreadValues({}, headerTextProps), { children: title })),
                /* @__PURE__ */ jsxs18("div", { className: "skc-page-header__trailing", children: [
                  ...
                  /* @__PURE__ */ jsx26(
                    ...
                    __spreadValues({
                      appearance: "text",
                      icon: brand || /* @__PURE__ */ jsx26(MaterialIcon, { icon: "home" }),
                      href: homeURL,
                      element
                    }, backAttr)
                  ),
...
function ThemeProvider({ children }) {
  return /* @__PURE__ */ jsx28(Fragment11, { children });
}
