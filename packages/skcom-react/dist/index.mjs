...
function DialogHeader({
  ...
  return /* @__PURE__ */ jsxs9("div", { style, className: cn(["skc-dialog-header", className]), children: [
    icon && /* @__PURE__ */ jsx15("div", { className: "skc-dialog-header__icon", children: icon }),
    title && /* @__PURE__ */ jsx15("h2", { "aria-label": alt, id: `${dialogID}-title`, children: title }),
    /* @__PURE__ */ jsx15(
      "p",
      {
...
function useScrollDirection() {
  const [direction, setDirection] = React9.useState("up");
  React9.useEffect(() => {
    let prevScrollY = 0;
    const handleScroll = () => {
...
function useMediaQuery(query) {
  const [isMatch, setIsMatch] = React9.useState(false);
  React9.useEffect(() => {
...
function FullscreenDialog({
  ...
  return /* @__PURE__ */ jsx17(AnimatePresence3, { children: open && /* @__PURE__ */ jsxs10(Fragment6, { children: [
    /* @__PURE__ */ jsxs10(
      motion9.div,
      {
        role: "alertdialog",
        ...
        children: [
          /* @__PURE__ */ jsxs10("div", { className: "skc-fullscreen-dialog__top-app-bar", children: [
            /* @__PURE__ */ jsx17(
              Button,
              {
                appearance: "text",
                icon: /* @__PURE__ */ jsx17(MaterialIcon, { icon: "close" }),
                alt: locale === "th" ? "\u0E1B\u0E34\u0E14\u0E2B\u0E19\u0E49\u0E32\u0E15\u0E48\u0E32\u0E07" : "Close",
                onClick: onClose
              }
            ),
            /* @__PURE__ */ jsx17("h2", { id: `${dialogID}-title`, children: title }),
            action
          ] }),
          /* @__PURE__ */ jsx17(motion9.div, { className: "skc-fullscreen-dialog__content", children: injectedChildren })
        ]
      }
    ),
    /* @__PURE__ */ jsx17(
...
function Divider({ style, className }) {
  return /* @__PURE__ */ jsx18("hr", { style, className: cn(["skc-divider", className]) });
}
...
import { Fragment as Fragment7, jsx as jsx19, jsxs as jsxs11 } from "react/jsx-runtime";
function Header({
  children,
  level,
  icon,
  ...
  const content = /* @__PURE__ */ jsxs11(Fragment7, { children: [
    icon && /* @__PURE__ */ jsx19("span", { className: "skc-header__icon", children: icon }),
    /* @__PURE__ */ jsx19("span", { className: "skc-header__text", children })
  ] });
  return level === 6 ? /* @__PURE__ */ jsx19("h6", __spreadProps(__spreadValues({}, props), { children: content })) : level === 5 ? /* @__PURE__ */ jsx19("h5", __spreadProps(__spreadValues({}, props), { children: content })) : level === 4 ? /* @__PURE__ */ jsx19("h4", __spreadProps(__spreadValues({}, props), { children: content })) : level === 3 ? /* @__PURE__ */ jsx19("h3", __spreadProps(__spreadValues({}, props), { children: content })) : /* @__PURE__ */ jsx19("h2", __spreadProps(__spreadValues({}, props), { children: content }));
}
...
function List({
  ...
  return /* @__PURE__ */ jsx20(
    "ul",
    {
      ...
      children: columns ? /* @__PURE__ */ jsx20(Columns, { columns, children }) : children
    }
  );
}
...
function ListItem({
  ...
  const content = /* @__PURE__ */ jsxs12(Fragment8, { children: [
    children,
    stateLayerEffect && /* @__PURE__ */ jsx21(
      motion10.span,
      {
        initial: { scale: 0, opacity: 0.36 },
        animate: rippleControls,
  ...
  return (
    ...
    href || onClick || stateLayerEffect ? /* @__PURE__ */ jsx21("li", {
      "aria-labelledby": itemID,
      // Render with `element` if defined
      children: href && Element ? /* @__PURE__ */ jsx21(Element, __spreadProps(__spreadValues({}, props), { href, children: content })) : (
        // Render an `<a>` if link passed in
        href ? /* @__PURE__ */ jsx21("a", __spreadProps(__spreadValues({}, props), { href, children: content })) : (
          // Otherwise, render a `<button>`
          /* @__PURE__ */ jsx21("button", __spreadProps(__spreadValues({}, __spreadProps(__spreadValues({}, props), { onClick })), { type: "button", children: content }))
        )
      )
    }) : (
      // If this Item has no functionality, just render a `<li>`
      /* @__PURE__ */ jsx21("li", __spreadProps(__spreadValues({}, props), { children: content }))
    )
  );
}
...
function ListItemContent({
  ...
  return /* @__PURE__ */ jsxs13("div", { style, className: cn(["skc-list-item-content", className]), children: [
    overline && /* @__PURE__ */ jsx22("span", { className: "skc-list-item-content__overline", children: overline }),
    /* @__PURE__ */ jsx22(
      "span",
      {
    ...
    desc && /* @__PURE__ */ jsx22("span", { className: "skc-list-item-content__desc", children: desc })
  ] });
}
...
function NavBar({
  ...
  return /* @__PURE__ */ jsxs14("nav", { style, className: cn(["skc-nav-bar", className]), children: [
    /* @__PURE__ */ jsxs14("div", { className: "skc-nav-bar__main", children: [
      /* @__PURE__ */ jsxs14("section", { className: "skc-nav-bar__toggle-and-fab", children: [
        /* @__PURE__ */ jsx23(
          Button,
          {
            appearance: "text",
            icon: /* @__PURE__ */ jsx23(MaterialIcon, { icon: "menu" }),
            alt: locale === "th" ? "\u0E40\u0E1B\u0E34\u0E14\u0E40\u0E21\u0E19\u0E39" : "Toggle Navigation Drawer",
            onClick: onNavToggle
          }
        ),
        /* @__PURE__ */ jsx23("div", { className: "skc-nav-bar__brand", children: brand }),
        atBreakpoint === "base" ? fab : navRailFab
      ] }),
      /* @__PURE__ */ jsx23("section", { className: "skc-nav-bar__destinations", children })
    ] }),
    /* @__PURE__ */ jsx23("section", { className: "skc-nav-bar__end", children: end })
  ] });
}
...
// src/components/NavBarItem/index.tsx
import { Fragment as Fragment9, jsx as jsx24, jsxs as jsxs15 } from "react/jsx-runtime";
function NavBarItem({
  icon,
  label,
  alt,
  ...
  const content = /* @__PURE__ */ jsxs15(Fragment9, { children: [
    /* @__PURE__ */ jsxs15("div", { ref: iconRef, className: "skc-nav-bar-item__icon", children: [
      icon,
      /* @__PURE__ */ jsx24(LayoutGroup, { children: /* @__PURE__ */ jsx24(AnimatePresence4, { children: badge !== void 0 && /* @__PURE__ */ jsx24(
        motion11.div,
        {
          initial: { scale: 0 },
          animate: { scale: 1 },
    ...
    label && /* @__PURE__ */ jsx24("span", { id: navID, className: "skc-nav-bar-item__label", children: label })
  ] });
  return (
    // Render with `element` if defined
    Element ? /* @__PURE__ */ jsx24(Element, __spreadProps(__spreadValues({}, props), { children: content })) : (
      // Otherwise, render an `<a>`
      /* @__PURE__ */ jsx24("a", __spreadProps(__spreadValues({}, props), { children: content }))
    )
  );
}
...
function NavDrawer({
  ...
  return /* @__PURE__ */ jsx25(AnimatePresence5, { children: open && /* @__PURE__ */ jsxs16(Fragment10, { children: [
    /* @__PURE__ */ jsx25(
      motion12.aside,
      {
        ...
        children: /* @__PURE__ */ jsx25("nav", { children: injectedChildren })
      }
    ),
    /* @__PURE__ */ jsx25(
      motion12.div,
  ...
  return /* @__PURE__ */ jsxs17(
    "section",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsx26("ul", { role: "list", children })
      ]
    }
  );
}
...
import { Fragment as Fragment11, jsx as jsx27, jsxs as jsxs18 } from "react/jsx-runtime";
function NavDrawerItem({
  ...
  const content = /* @__PURE__ */ jsxs18(Fragment11, { children: [
    /* @__PURE__ */ jsx27("div", { className: "skc-nav-drawer-item__icon", children: icon }),
    /* @__PURE__ */ jsx27("span", { className: "skc-nav-drawer-item__label", children: label }),
    metadata && /* @__PURE__ */ jsx27("span", { className: "skc-nav-drawer-item__metadata", children: metadata }),
    /* @__PURE__ */ jsx27(
      motion13.span,
      {
        initial: { scale: 0, opacity: 0.36 },
  ...
  return /* @__PURE__ */ jsx27("li", { children: Element ? /* @__PURE__ */ jsx27(Element, __spreadProps(__spreadValues({}, props), { children: content })) : /* @__PURE__ */ jsx27("a", __spreadProps(__spreadValues({}, props), { children: content })) });
}
...
function FAB({
  ...
  const content = /* @__PURE__ */ jsx28(AnimatePresence6, {
    initial: false,
    // Hide the FAB on scroll if `stateOnScroll` set to `disappear`
    children: !(stateOnScroll === "disappear" && canHide && scrollDir === "down") && /* @__PURE__ */ jsxs19(
      motion14.div,
      {
        ref: fabRef,
        ...
        children: [
          icon && /* @__PURE__ */ jsx28("div", { className: "skc-fab__icon", children: icon }),
          // Hide the label on scroll if `stateOnScroll` set to `minimize`
          !(stateOnScroll === "minimize" && !(scrollDir === "up")) && children && /* @__PURE__ */ jsx28("span", { className: "skc-fab__label", children }),
          /* @__PURE__ */ jsx28(
            motion14.span,
            {
              initial: { scale: 0, opacity: 0.36 },
  ...
  return (
    // Render with `element` if defined
    href && Element ? /* @__PURE__ */ jsx28(Element, __spreadProps(__spreadValues({}, props), { href, children: content })) : (
      // Render an `<a>` if link passed in
      href ? /* @__PURE__ */ jsx28("a", __spreadProps(__spreadValues({ href }, props), { children: content })) : (
        // Otherwise, render a `<button>`
        /* @__PURE__ */ jsx28("button", __spreadProps(__spreadValues({ type: "button", onClick }, props), { children: content }))
      )
    )
  );
}
...
function ContentLayout({
  ...
  return /* @__PURE__ */ jsx29(
    motion15.main,
    {
      ...
      children: /* @__PURE__ */ jsx29("div", { className: "skc-content-layout__content", children })
    }
  );
}
...
function RootLayout({ children, className, style }) {
  ...
  return /* @__PURE__ */ jsxs20("div", { style, className: cn(["skc-root-layout", className]), children: [
...
function PageHeader({
  ...
  return /* @__PURE__ */ jsxs21(Fragment12, { children: [
    /* @__PURE__ */ jsx31("div", { className: "skc-page-header__replacement-color" }),
    /* @__PURE__ */ jsx31(
      "div",
      {
    ...
    /* @__PURE__ */ jsx31(LayoutGroup2, { children: /* @__PURE__ */ jsx31(
      motion16.header,
      {
        ref: headerRef,
        ...
        children: /* @__PURE__ */ jsxs21("div", { className: "skc-page-header__content", children: [
          icon && !children && /* @__PURE__ */ jsx31(
            motion16.div,
            {
            ...
            motion16.div,
            {
              ...
              children: [
                /* @__PURE__ */ jsx31(
                  ...
                  {
                    appearance: "text",
                    icon: /* @__PURE__ */ jsx31(MaterialIcon, { icon: "arrow_backward" }),
                ...
                /* @__PURE__ */ jsx31(motion16.h1, __spreadProps(__spreadValues({}, headerTextProps), { children: title })),
                /* @__PURE__ */ jsxs21("div", { className: "skc-page-header__trailing", children: [
                  homeURL && // Home Button
                  /* @__PURE__ */ jsx31(
                    Button,
                    __spreadValues({
                      appearance: "text",
                      icon: brand || /* @__PURE__ */ jsx31(MaterialIcon, { icon: "home" }),
                      href: homeURL,
                      element
                    }, backAttr)
                  ),
                  /* @__PURE__ */ jsx31(
                    ...
                    {
                      appearance: "text",
                      icon: /* @__PURE__ */ jsx31(MaterialIcon, { icon: "menu" }),
                      onClick: onNavToggle
                    }
                  )
                ] })
...
function Switch({
  ...
  return /* @__PURE__ */ jsx33(
    ...
    __spreadProps(__spreadValues({
      ...
      children: /* @__PURE__ */ jsx33("div", { className: "skc-switch__handle", children: value ? onIcon : offIcon })
    })
  );
}
  ...
  return /* @__PURE__ */ jsxs22(
    "label",
    {
      ...
      children: [
        ...
        leading && /* @__PURE__ */ jsx34(motion17.div, { className: "skc-text-field__leading", children: leading }),
        behavior === "single-line" ? /* @__PURE__ */ jsx34("input", __spreadValues(__spreadValues({}, inputProps), inputAttr)) : /* @__PURE__ */ jsx34("textarea", __spreadValues({ ref: textareaRef }, inputProps)),
        /* @__PURE__ */ jsx34(LayoutGroup3, { children: /* @__PURE__ */ jsxs22(AnimatePresence9, { initial: false, children: [
          ...
          (canClear || error) && /* @__PURE__ */ jsx34(
            motion17.div,
            {
              ...
              transition: fieldTransition,
              className: "skc-text-field__trailing",
              children: canClear ? /* @__PURE__ */ jsx34(
                Button,
                {
                  appearance: "text",
                  icon: /* @__PURE__ */ jsx34(MaterialIcon, { icon: "cancel" }),
                  disabled,
                  onClick: () => onChange && onChange("")
                }
              ) : error ? /* @__PURE__ */ jsx34(MaterialIcon, { icon: "error", fill: true }) : null
            }
          )
        ] }) }),
        helperMsg && /* @__PURE__ */ jsx34("span", { id: `${fieldID}-helper`, className: "skc-text-field__helper-msg", children: helperMsg })
      ]
    }
  );
}
...
import { Fragment as Fragment13, jsx as jsx35 } from "react/jsx-runtime";
function ThemeProvider({ children }) {
  return /* @__PURE__ */ jsx35(Fragment13, { children });
}
