...
function AssistChip({
  ...
  return href && element ? element({ ...props, children: content, href }) : href ? /* @__PURE__ */ jsx6("a", {
    ...props,
    href,
    children: content
...
function FAB({
  ...
  const content = /* @__PURE__ */ jsx7(AnimatePresence, {
    children: !(stateOnScroll === "disappear" && !(scrollDir === "up")) && /* @__PURE__ */ jsxs4(motion5.div, {
      ref: fabRef,
      style,
      className: cn([
        "skc-fab",
      ...
      children: [
        ...
        !(stateOnScroll === "minimize" && !(scrollDir === "up")) && children && /* @__PURE__ */ jsx7("span", {
          className: "skc-fab__label",
          children
        }),
        /* @__PURE__ */ jsx7(motion5.span, {
          initial: { scale: 0, opacity: 0.36 },
          animate: rippleControls,
