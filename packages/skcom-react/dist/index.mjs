...
function Card({
  ...
  return (
    ...
    href && Element ? /* @__PURE__ */ jsx8(Element, __spreadProps(__spreadValues({}, props), { href, children: content })) : (
      // Render an `<a>` if link passed in
      href ? layoutID ? /* @__PURE__ */ jsx8(motion5.a, __spreadProps(__spreadValues({}, props), { layoutId: layoutID, children: content })) : /* @__PURE__ */ jsx8("a", __spreadProps(__spreadValues({}, props), { href, children: content })) : (
        ...
        onClick ? layoutID ? /* @__PURE__ */ jsx8(
          ...
          layoutID ? /* @__PURE__ */ jsx8(motion5.div, __spreadProps(__spreadValues({}, props), { layoutId: layoutID, children: content })) : /* @__PURE__ */ jsx8("div", __spreadProps(__spreadValues({}, props), { children: content }))
        )
      )
    )
  );
...
function InputChip({
  ...
  const divContent = /* @__PURE__ */ jsxs6(Fragment3, { children: [
    avatar && /* @__PURE__ */ jsx12("div", { className: "skc-input-chip__avatar", children: selected ? /* @__PURE__ */ jsx12(MaterialIcon, { icon: "done" }) : avatar }),
    icon && /* @__PURE__ */ jsx12("div", { className: "skc-input-chip__icon", children: icon }),
    /* @__PURE__ */ jsx12("span", { className: "skc-input-chip__label", children }),
    onDelete && /* @__PURE__ */ jsx12(
      Button,
      {
        appearance: "text",
        icon: /* @__PURE__ */ jsx12(MaterialIcon, { icon: "close" }),
        onClick: onDelete
      }
    )
  ] });
  const buttonContent = /* @__PURE__ */ jsxs6(Fragment3, { children: [
    divContent,
    /* @__PURE__ */ jsx12(
      motion6.span,
      {
  ...
  ) : editable || onClick ? layoutID ? /* @__PURE__ */ jsx12(motion6.button, __spreadProps(__spreadValues({ layoutId: layoutID }, buttonProps), { children: buttonContent })) : /* @__PURE__ */ jsx12("button", __spreadProps(__spreadValues({}, buttonProps), { children: buttonContent })) : layoutID ? /* @__PURE__ */ jsx12(motion6.div, __spreadProps(__spreadValues({ layoutId: layoutID }, divProps), { children: divContent })) : /* @__PURE__ */ jsx12("div", __spreadProps(__spreadValues({}, divProps), { children: divContent }));
}
...
function AssistChip({
  ...
  const content = /* @__PURE__ */ jsxs7(Fragment4, { children: [
    icon && /* @__PURE__ */ jsx13("div", { className: "skc-assist-chip__icon", children: icon }),
    /* @__PURE__ */ jsx13("span", { className: "skc-assist-chip__label", children }),
    /* @__PURE__ */ jsx13(
      motion7.span,
      {
        initial: { scale: 0, opacity: 0.36 },
  ...
  return (
    // Render with `element` if defined
    href && Element ? /* @__PURE__ */ jsx13(Element, __spreadProps(__spreadValues({}, props), { href, children: content })) : (
      // Render an `<a>` if link passed in
      href ? /* @__PURE__ */ jsx13("a", __spreadProps(__spreadValues({}, props), { href, children: content })) : (
        // Otherwise, render a `<button>`
        /* @__PURE__ */ jsx13("button", __spreadProps(__spreadValues({}, props), { type: "button", children: content }))
      )
    )
  );
}
...
function ChipSet({
  ...
  return /* @__PURE__ */ jsx14(
    "div",
    {
      ...
      children: scrollable ? /* @__PURE__ */ jsx14("div", { className: "skc-chip-set", children }) : children
    }
  );
}
...
function ChipField({
  ...
  return /* @__PURE__ */ jsxs8("div", { style, className: cn(["skc-chip-field", className]), children: [
    /* @__PURE__ */ jsx15(motion8.label, { animate: labelControls, className: "skc-chip-field__label", children: "Classes learning this subject" }),
    /* @__PURE__ */ jsx15("div", { className: "skc-chip-field__scrollable", children: /* @__PURE__ */ jsxs8("div", { className: "skc-chip-field__content", children: [
      lastSelected ? (
        // Modify the Chip Set so that the last Chip is displayed as
        // selected
        /* @__PURE__ */ jsx15(ChipSet, { children: React8.Children.map(
          React8.Children.only(children).props.children,
          (child, idx) => {
            if (idx === noOfChips - 1)
...
function Dialog({
  ...
  return /* @__PURE__ */ jsx16(AnimatePresence2, { children: open && /* @__PURE__ */ jsxs9(Fragment5, { children: [
    /* @__PURE__ */ jsx16(
      motion9.div,
      {
        role: "alertdialog",
...
function DialogHeader({
  ...
  return /* @__PURE__ */ jsxs10("div", { style, className: cn(["skc-dialog-header", className]), children: [
    icon && /* @__PURE__ */ jsx17("div", { className: "skc-dialog-header__icon", children: icon }),
    title && /* @__PURE__ */ jsx17("h2", { "aria-label": alt, id: `${dialogID}-title`, children: title }),
    /* @__PURE__ */ jsx17(
      "p",
      {
...
function useScrollDirection() {
  const [direction, setDirection] = React10.useState("up");
  React10.useEffect(() => {
    let prevScrollY = 0;
    const handleScroll = () => {
...
function useMediaQuery(query) {
  const [isMatch, setIsMatch] = React10.useState(false);
  React10.useEffect(() => {
...
function FullscreenDialog({
  ...
  return /* @__PURE__ */ jsx19(AnimatePresence3, { children: open && /* @__PURE__ */ jsxs11(Fragment6, { children: [
    /* @__PURE__ */ jsxs11(
      motion10.div,
      {
        role: "alertdialog",
        ...
        children: [
          /* @__PURE__ */ jsxs11("div", { className: "skc-fullscreen-dialog__top-app-bar", children: [
            /* @__PURE__ */ jsx19(
              Button,
              {
                appearance: "text",
                icon: /* @__PURE__ */ jsx19(MaterialIcon, { icon: "close" }),
                alt: locale === "th" ? "\u0E1B\u0E34\u0E14\u0E2B\u0E19\u0E49\u0E32\u0E15\u0E48\u0E32\u0E07" : "Close",
                onClick: onClose
              }
            ),
            /* @__PURE__ */ jsx19("h2", { id: `${dialogID}-title`, children: title }),
            action
          ] }),
          /* @__PURE__ */ jsx19(motion10.div, { className: "skc-fullscreen-dialog__content", children: injectedChildren })
        ]
      }
    ),
    /* @__PURE__ */ jsx19(
...
function Divider({ style, className }) {
  return /* @__PURE__ */ jsx20("hr", { style, className: cn(["skc-divider", className]) });
}
...
function Header({
  ...
  const content = /* @__PURE__ */ jsxs12(Fragment7, { children: [
    icon && /* @__PURE__ */ jsx21("span", { className: "skc-header__icon", children: icon }),
    /* @__PURE__ */ jsx21("span", { className: "skc-header__text", children })
  ] });
  return level === 6 ? /* @__PURE__ */ jsx21("h6", __spreadProps(__spreadValues({}, props), { children: content })) : level === 5 ? /* @__PURE__ */ jsx21("h5", __spreadProps(__spreadValues({}, props), { children: content })) : level === 4 ? /* @__PURE__ */ jsx21("h4", __spreadProps(__spreadValues({}, props), { children: content })) : level === 3 ? /* @__PURE__ */ jsx21("h3", __spreadProps(__spreadValues({}, props), { children: content })) : /* @__PURE__ */ jsx21("h2", __spreadProps(__spreadValues({}, props), { children: content }));
}
...
function List({
  ...
  return /* @__PURE__ */ jsx22(
    "ul",
    {
      ...
      children: columns ? /* @__PURE__ */ jsx22(Columns, { columns, children }) : children
    }
  );
}
...
function ListItem({
  ...
  const content = /* @__PURE__ */ jsxs13(Fragment8, { children: [
    children,
    stateLayerEffect && /* @__PURE__ */ jsx23(
      motion11.span,
      {
        initial: { scale: 0, opacity: 0.36 },
        animate: rippleControls,
  ...
  return (
    ...
    href || onClick || stateLayerEffect ? /* @__PURE__ */ jsx23("li", {
      "aria-labelledby": itemID,
      // Render with `element` if defined
      children: href && Element ? /* @__PURE__ */ jsx23(Element, __spreadProps(__spreadValues({}, props), { href, children: content })) : (
        // Render an `<a>` if link passed in
        href ? /* @__PURE__ */ jsx23("a", __spreadProps(__spreadValues({}, props), { href, children: content })) : (
          // Otherwise, render a `<button>`
          /* @__PURE__ */ jsx23("button", __spreadProps(__spreadValues({}, __spreadProps(__spreadValues({}, props), { onClick })), { type: "button", children: content }))
        )
      )
    }) : (
      // If this Item has no functionality, just render a `<li>`
      /* @__PURE__ */ jsx23("li", __spreadProps(__spreadValues({}, props), { children: content }))
    )
  );
}
...
function ListItemContent({
  ...
  return /* @__PURE__ */ jsxs14("div", { style, className: cn(["skc-list-item-content", className]), children: [
    overline && /* @__PURE__ */ jsx24("span", { className: "skc-list-item-content__overline", children: overline }),
    /* @__PURE__ */ jsx24(
      "span",
      {
    ...
    desc && /* @__PURE__ */ jsx24("span", { className: "skc-list-item-content__desc", children: desc })
  ] });
}
...
function NavBar({
  ...
  return /* @__PURE__ */ jsxs15("nav", { style, className: cn(["skc-nav-bar", className]), children: [
    /* @__PURE__ */ jsxs15("div", { className: "skc-nav-bar__main", children: [
      /* @__PURE__ */ jsxs15("section", { className: "skc-nav-bar__toggle-and-fab", children: [
        /* @__PURE__ */ jsx25(
          Button,
          {
            appearance: "text",
            icon: /* @__PURE__ */ jsx25(MaterialIcon, { icon: "menu" }),
            alt: locale === "th" ? "\u0E40\u0E1B\u0E34\u0E14\u0E40\u0E21\u0E19\u0E39" : "Toggle Navigation Drawer",
            onClick: onNavToggle
          }
        ),
        /* @__PURE__ */ jsx25("div", { className: "skc-nav-bar__brand", children: brand }),
        atBreakpoint === "base" ? fab : navRailFab
      ] }),
      /* @__PURE__ */ jsx25("section", { className: "skc-nav-bar__destinations", children })
    ] }),
    /* @__PURE__ */ jsx25("section", { className: "skc-nav-bar__end", children: end })
  ] });
}
...
function NavBarItem({
  ...
  const content = /* @__PURE__ */ jsxs16(Fragment9, { children: [
    /* @__PURE__ */ jsxs16("div", { ref: iconRef, className: "skc-nav-bar-item__icon", children: [
      icon,
      /* @__PURE__ */ jsx26(LayoutGroup, { children: /* @__PURE__ */ jsx26(AnimatePresence4, { children: badge !== void 0 && /* @__PURE__ */ jsx26(
        motion12.div,
        {
          initial: { scale: 0 },
          animate: { scale: 1 },
    ...
    label && /* @__PURE__ */ jsx26("span", { id: navID, className: "skc-nav-bar-item__label", children: label })
  ] });
  return (
    // Render with `element` if defined
    Element ? /* @__PURE__ */ jsx26(Element, __spreadProps(__spreadValues({}, props), { children: content })) : (
      // Otherwise, render an `<a>`
      /* @__PURE__ */ jsx26("a", __spreadProps(__spreadValues({}, props), { children: content }))
    )
  );
}
...
function NavDrawer({
  ...
  return /* @__PURE__ */ jsx27(AnimatePresence5, { children: open && /* @__PURE__ */ jsxs17(Fragment10, { children: [
    /* @__PURE__ */ jsx27(
      motion13.aside,
      {
        ...
        children: /* @__PURE__ */ jsx27("nav", { children: injectedChildren })
      }
    ),
    /* @__PURE__ */ jsx27(
      motion13.div,
  ...
  return /* @__PURE__ */ jsxs18(
    "section",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsx28("ul", { role: "list", children })
      ]
    }
  );
}
...
function NavDrawerItem({
  ...
  const content = /* @__PURE__ */ jsxs19(Fragment11, { children: [
    /* @__PURE__ */ jsx29("div", { className: "skc-nav-drawer-item__icon", children: icon }),
    /* @__PURE__ */ jsx29("span", { className: "skc-nav-drawer-item__label", children: label }),
    metadata && /* @__PURE__ */ jsx29("span", { className: "skc-nav-drawer-item__metadata", children: metadata }),
    /* @__PURE__ */ jsx29(
      motion14.span,
      {
        initial: { scale: 0, opacity: 0.36 },
  ...
  return /* @__PURE__ */ jsx29("li", { children: Element ? /* @__PURE__ */ jsx29(Element, __spreadProps(__spreadValues({}, props), { children: content })) : /* @__PURE__ */ jsx29("a", __spreadProps(__spreadValues({}, props), { children: content })) });
}
...
function FAB({
  ...
  const content = /* @__PURE__ */ jsx30(AnimatePresence6, {
    initial: false,
    // Hide the FAB on scroll if `stateOnScroll` set to `disappear`
    children: !(stateOnScroll === "disappear" && canHide && scrollDir === "down") && /* @__PURE__ */ jsxs20(
      motion15.div,
      {
        ref: fabRef,
        ...
        children: [
          icon && /* @__PURE__ */ jsx30("div", { className: "skc-fab__icon", children: icon }),
          // Hide the label on scroll if `stateOnScroll` set to `minimize`
          !(stateOnScroll === "minimize" && !(scrollDir === "up")) && children && /* @__PURE__ */ jsx30("span", { className: "skc-fab__label", children }),
          /* @__PURE__ */ jsx30(
            motion15.span,
            {
              initial: { scale: 0, opacity: 0.36 },
  ...
  return (
    // Render with `element` if defined
    href && Element ? /* @__PURE__ */ jsx30(Element, __spreadProps(__spreadValues({}, props), { href, children: content })) : (
      // Render an `<a>` if link passed in
      href ? /* @__PURE__ */ jsx30("a", __spreadProps(__spreadValues({ href }, props), { children: content })) : (
        // Otherwise, render a `<button>`
        /* @__PURE__ */ jsx30("button", __spreadProps(__spreadValues({ type: "button", onClick }, props), { children: content }))
      )
    )
  );
}
...
function ContentLayout({
  ...
  return /* @__PURE__ */ jsx31(
    motion16.main,
    {
      ...
      children: /* @__PURE__ */ jsx31("div", { className: "skc-content-layout__content", children })
    }
  );
}
...
function RootLayout({ children, className, style }) {
  ...
  return /* @__PURE__ */ jsxs21("div", { style, className: cn(["skc-root-layout", className]), children: [
...
function PageHeader({
  ...
  const headerTextControls = useAnimationControls3();
  React19.useEffect(() => {
  ...
  const iconControls = useAnimationControls3();
  React19.useEffect(() => {
    if (icon || !minimized) {
  ...
  return /* @__PURE__ */ jsxs22(Fragment12, { children: [
    /* @__PURE__ */ jsx33("div", { className: "skc-page-header__replacement-color" }),
    /* @__PURE__ */ jsx33(
      "div",
      {
    ...
    /* @__PURE__ */ jsx33(LayoutGroup2, { children: /* @__PURE__ */ jsx33(
      motion17.header,
      {
        ref: headerRef,
        ...
        children: /* @__PURE__ */ jsxs22("div", { className: "skc-page-header__content", children: [
          icon && !children && /* @__PURE__ */ jsx33(
            motion17.div,
            {
            ...
            motion17.div,
            {
              ...
              children: [
                /* @__PURE__ */ jsx33(
                  ...
                  {
                    appearance: "text",
                    icon: /* @__PURE__ */ jsx33(MaterialIcon, { icon: "arrow_backward" }),
                ...
                /* @__PURE__ */ jsx33(motion17.h1, __spreadProps(__spreadValues({}, headerTextProps), { children: title })),
                /* @__PURE__ */ jsxs22("div", { className: "skc-page-header__trailing", children: [
                  homeURL && // Home Button
                  /* @__PURE__ */ jsx33(
                    Button,
                    __spreadValues({
                      appearance: "text",
                      icon: brand || /* @__PURE__ */ jsx33(MaterialIcon, { icon: "home" }),
                      href: homeURL,
                      element
                    }, backAttr)
                  ),
...
function Switch({
  ...
  return /* @__PURE__ */ jsx35(
    ...
    __spreadProps(__spreadValues({
      ...
      children: /* @__PURE__ */ jsx35("div", { className: "skc-switch__handle", children: value ? onIcon : offIcon })
    })
  );
}
...
import {
  ...
  motion as motion18,
  useAnimationControls as useAnimationControls4
} from "framer-motion";
...
function TextField({
  ...
  const { duration, easing } = useAnimationConfig();
  const labelControls = useAnimationControls4();
  const trailingControls = useAnimationControls4();
  ...
  return /* @__PURE__ */ jsxs23(
    "label",
    {
      ...
      children: [
        ...
        leading && /* @__PURE__ */ jsx36(motion18.div, { className: "skc-text-field__leading", children: leading }),
        behavior === "single-line" ? /* @__PURE__ */ jsx36("input", __spreadValues(__spreadValues({}, inputProps), inputAttr)) : /* @__PURE__ */ jsx36("textarea", __spreadValues({ ref: textareaRef }, inputProps)),
        /* @__PURE__ */ jsx36(LayoutGroup3, { children: /* @__PURE__ */ jsxs23(AnimatePresence9, { initial: false, children: [
          trailing && /* @__PURE__ */ jsx36(
            motion18.div,
            {
          ...
          (canClear || error) && /* @__PURE__ */ jsx36(
            motion18.div,
            {
              ...
              transition: fieldTransition,
              className: "skc-text-field__trailing",
              children: canClear ? /* @__PURE__ */ jsx36(
                Button,
                {
                  appearance: "text",
                  icon: /* @__PURE__ */ jsx36(MaterialIcon, { icon: "cancel" }),
                  disabled,
                  onClick: () => onChange && onChange("")
                }
              ) : error ? /* @__PURE__ */ jsx36(MaterialIcon, { icon: "error", fill: true }) : null
            }
          )
        ] }) }),
        helperMsg && /* @__PURE__ */ jsx36("span", { id: `${fieldID}-helper`, className: "skc-text-field__helper-msg", children: helperMsg })
      ]
    }
  );
}
...
function ThemeProvider({ children }) {
  return /* @__PURE__ */ jsx37(Fragment13, { children });
}
