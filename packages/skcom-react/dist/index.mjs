        ...
        /* @__PURE__ */ jsx32(LayoutGroup3, { children: /* @__PURE__ */ jsxs21(AnimatePresence9, { children: [
          ...
          (canClear || error) && /* @__PURE__ */ jsx32(
            motion16.div,
            {
              ...
              transition: fieldTransition,
              className: "skc-text-field__trailing",
              children: canClear ? /* @__PURE__ */ jsx32(
                Button,
                {
                  appearance: "text",
                  icon: /* @__PURE__ */ jsx32(MaterialIcon, { icon: "cancel" }),
                  disabled,
                  onClick: () => onChange && onChange("")
                }
              ) : error ? /* @__PURE__ */ jsx32(MaterialIcon, { icon: "error", fill: true }) : null
            }
          )
        ] }) }),
        helperMsg && /* @__PURE__ */ jsx32("span", { id: `${fieldID}-helper`, className: "skc-text-field__helper-msg", children: helperMsg })
      ]
    }
  );
}
...
function ThemeProvider({ children }) {
  return /* @__PURE__ */ jsx33(Fragment12, { children });
}
