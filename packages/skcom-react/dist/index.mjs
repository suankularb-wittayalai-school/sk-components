...
function Dialog({
  ...
  return /* @__PURE__ */ jsx15(AnimatePresence2, { children: open && /* @__PURE__ */ jsxs8(Fragment5, { children: [
    /* @__PURE__ */ jsx15(
      motion8.div,
      {
        role: "alertdialog",
...
function DialogHeader({
  ...
  return /* @__PURE__ */ jsxs9("div", { style, className: cn(["skc-dialog-header", className]), children: [
    icon && /* @__PURE__ */ jsx16("div", { className: "skc-dialog-header__icon", children: icon }),
    title && /* @__PURE__ */ jsx16("h2", { "aria-label": alt, id: `${dialogID}-title`, children: title }),
    /* @__PURE__ */ jsx16(
      "p",
      {
...
function FullscreenDialog({
  ...
  return /* @__PURE__ */ jsx18(AnimatePresence3, { children: open && /* @__PURE__ */ jsxs10(Fragment6, { children: [
    /* @__PURE__ */ jsxs10(
      motion9.div,
      {
        role: "alertdialog",
        ...
        children: [
          /* @__PURE__ */ jsxs10("div", { className: "skc-fullscreen-dialog__top-app-bar", children: [
            /* @__PURE__ */ jsx18(
              ...
              {
                appearance: "text",
                icon: /* @__PURE__ */ jsx18(MaterialIcon, { icon: "close" }),
                alt: locale === "th" ? "\u0E1B\u0E34\u0E14\u0E2B\u0E19\u0E49\u0E32\u0E15\u0E48\u0E32\u0E07" : "Close",
                onClick: onClose
              }
            ),
            /* @__PURE__ */ jsx18("h2", { id: `${dialogID}-title`, children: title }),
            action
          ] }),
          /* @__PURE__ */ jsx18(motion9.div, { className: "skc-fullscreen-dialog__content", children: injectedChildren })
        ]
      }
    ),
    /* @__PURE__ */ jsx18(
...
function Divider({ style, className }) {
  return /* @__PURE__ */ jsx19("hr", { style, className: cn(["skc-divider", className]) });
}
...
function Header({
  ...
  const content = /* @__PURE__ */ jsxs11(Fragment7, { children: [
    icon && /* @__PURE__ */ jsx20("span", { className: "skc-header__icon", children: icon }),
    /* @__PURE__ */ jsx20("span", { className: "skc-header__text", children })
  ] });
  return level === 6 ? /* @__PURE__ */ jsx20("h6", __spreadProps(__spreadValues({}, props), { children: content })) : level === 5 ? /* @__PURE__ */ jsx20("h5", __spreadProps(__spreadValues({}, props), { children: content })) : level === 4 ? /* @__PURE__ */ jsx20("h4", __spreadProps(__spreadValues({}, props), { children: content })) : level === 3 ? /* @__PURE__ */ jsx20("h3", __spreadProps(__spreadValues({}, props), { children: content })) : /* @__PURE__ */ jsx20("h2", __spreadProps(__spreadValues({}, props), { children: content }));
}
...
function List({
  ...
  return /* @__PURE__ */ jsx21(
    "ul",
    {
      ...
      children: columns ? /* @__PURE__ */ jsx21(Columns, { columns, children }) : children
    }
  );
}
...
function ListItem({
  ...
  const content = /* @__PURE__ */ jsxs12(Fragment8, { children: [
    children,
    stateLayerEffect && /* @__PURE__ */ jsx22(
      motion10.span,
      {
        initial: { scale: 0, opacity: 0.36 },
        animate: rippleControls,
  ...
  return (
    ...
    href || onClick || stateLayerEffect ? /* @__PURE__ */ jsx22("li", {
      "aria-labelledby": itemID,
      // Render with `element` if defined
      children: href && Element ? /* @__PURE__ */ jsx22(Element, __spreadProps(__spreadValues({}, props), { href, children: content })) : (
        // Render an `<a>` if link passed in
        href ? /* @__PURE__ */ jsx22("a", __spreadProps(__spreadValues({}, props), { href, children: content })) : (
          // Otherwise, render a `<button>`
          /* @__PURE__ */ jsx22("button", __spreadProps(__spreadValues({}, __spreadProps(__spreadValues({}, props), { onClick })), { type: "button", children: content }))
        )
      )
    }) : (
      // If this Item has no functionality, just render a `<li>`
      /* @__PURE__ */ jsx22("li", __spreadProps(__spreadValues({}, props), { children: content }))
    )
  );
}
...
function ListItemContent({
  ...
  return /* @__PURE__ */ jsxs13("div", { style, className: cn(["skc-list-item-content", className]), children: [
    overline && /* @__PURE__ */ jsx23("span", { className: "skc-list-item-content__overline", children: overline }),
    /* @__PURE__ */ jsx23(
      "span",
      {
    ...
    desc && /* @__PURE__ */ jsx23("span", { className: "skc-list-item-content__desc", children: desc })
  ] });
}
    ...
    /* @__PURE__ */ jsxs14("div", { className: "skc-nav-bar__main", children: [
      /* @__PURE__ */ jsxs14("section", { className: "skc-nav-bar__toggle-and-fab", children: [
        /* @__PURE__ */ jsx24(
          ...
          {
            appearance: "text",
            icon: /* @__PURE__ */ jsx24(MaterialIcon, { icon: "menu" }),
            alt: locale === "th" ? "\u0E40\u0E1B\u0E34\u0E14\u0E40\u0E21\u0E19\u0E39" : "Toggle Navigation Drawer",
            onClick: onNavToggle
          }
        ),
        /* @__PURE__ */ jsx24("div", { className: "skc-nav-bar__brand", children: brand }),
        atBreakpoint === "base" ? fab : navRailFab
      ] }),
      /* @__PURE__ */ jsx24("section", { className: "skc-nav-bar__destinations", children })
    ] }),
    /* @__PURE__ */ jsx24("section", { className: "skc-nav-bar__end", children: end })
  ] });
}
...
function NavBarItem({
  ...
  const content = /* @__PURE__ */ jsxs15(Fragment9, { children: [
    /* @__PURE__ */ jsxs15("div", { ref: iconRef, className: "skc-nav-bar-item__icon", children: [
      icon,
      /* @__PURE__ */ jsx25(LayoutGroup, { children: /* @__PURE__ */ jsx25(AnimatePresence4, { children: badge !== void 0 && /* @__PURE__ */ jsx25(
        motion11.div,
        {
          initial: { scale: 0 },
          animate: { scale: 1 },
    ...
    label && /* @__PURE__ */ jsx25("span", { id: navID, className: "skc-nav-bar-item__label", children: label })
  ] });
  return (
    // Render with `element` if defined
    Element ? /* @__PURE__ */ jsx25(Element, __spreadProps(__spreadValues({}, props), { children: content })) : (
      // Otherwise, render an `<a>`
      /* @__PURE__ */ jsx25("a", __spreadProps(__spreadValues({}, props), { children: content }))
    )
  );
}
...
function NavDrawer({
  ...
  return /* @__PURE__ */ jsx26(AnimatePresence5, { children: open && /* @__PURE__ */ jsxs16(Fragment10, { children: [
    /* @__PURE__ */ jsx26(
      motion12.aside,
      {
        ...
        children: /* @__PURE__ */ jsx26("nav", { children: injectedChildren })
      }
    ),
    /* @__PURE__ */ jsx26(
      motion12.div,
  ...
  return /* @__PURE__ */ jsxs17(
    "section",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsx27("ul", { role: "list", children })
      ]
    }
  );
}
...
function NavDrawerItem({
  ...
  const content = /* @__PURE__ */ jsxs18(Fragment11, { children: [
    /* @__PURE__ */ jsx28("div", { className: "skc-nav-drawer-item__icon", children: icon }),
    /* @__PURE__ */ jsx28("span", { className: "skc-nav-drawer-item__label", children: label }),
    metadata && /* @__PURE__ */ jsx28("span", { className: "skc-nav-drawer-item__metadata", children: metadata }),
    /* @__PURE__ */ jsx28(
      motion13.span,
      {
        initial: { scale: 0, opacity: 0.36 },
  ...
  return /* @__PURE__ */ jsx28("li", { children: Element ? /* @__PURE__ */ jsx28(Element, __spreadProps(__spreadValues({}, props), { children: content })) : /* @__PURE__ */ jsx28("a", __spreadProps(__spreadValues({}, props), { children: content })) });
}
...
function FAB({
  ...
  const content = /* @__PURE__ */ jsx29(AnimatePresence6, {
    initial: false,
    ...
    children: !(stateOnScroll === "disappear" && canHide && scrollDir === "down") && /* @__PURE__ */ jsxs19(
      motion14.div,
      {
        ...
        children: [
          icon && /* @__PURE__ */ jsx29("div", { className: "skc-fab__icon", children: icon }),
          // Hide the label on scroll if `stateOnScroll` set to `minimize`
          !(stateOnScroll === "minimize" && !(scrollDir === "up")) && children && /* @__PURE__ */ jsx29("span", { className: "skc-fab__label", children }),
          /* @__PURE__ */ jsx29(
            motion14.span,
            {
              initial: { scale: 0, opacity: 0.36 },
  ...
  return (
    // Render with `element` if defined
    href && Element ? /* @__PURE__ */ jsx29(Element, __spreadProps(__spreadValues({}, props), { href, children: content })) : (
      // Render an `<a>` if link passed in
      href ? /* @__PURE__ */ jsx29("a", __spreadProps(__spreadValues({ href }, props), { children: content })) : (
        // Otherwise, render a `<button>`
        /* @__PURE__ */ jsx29("button", __spreadProps(__spreadValues({ type: "button", onClick }, props), { children: content }))
      )
    )
  );
}
...
function ContentLayout({
  ...
  return /* @__PURE__ */ jsx30(
    motion15.main,
    {
      ...
      children: /* @__PURE__ */ jsx30("div", { className: "skc-content-layout__content", children })
    }
  );
}
...
function PageHeader({
  ...
  return /* @__PURE__ */ jsxs21(Fragment12, { children: [
    /* @__PURE__ */ jsx32("div", { className: "skc-page-header__replacement-color" }),
    /* @__PURE__ */ jsx32(
      "div",
      {
    ...
    /* @__PURE__ */ jsx32(LayoutGroup2, { children: /* @__PURE__ */ jsx32(
      motion16.header,
      {
        ref: headerRef,
            ...
            motion16.div,
            {
              ...
              children: [
                /* @__PURE__ */ jsx32(
                  ...
                  {
                    appearance: "text",
                    icon: /* @__PURE__ */ jsx32(MaterialIcon, { icon: "arrow_backward" }),
                ...
                /* @__PURE__ */ jsx32(motion16.h1, __spreadProps(__spreadValues({}, headerTextProps), { children: title })),
                /* @__PURE__ */ jsxs21("div", { className: "skc-page-header__trailing", children: [
                  ...
                  /* @__PURE__ */ jsx32(
                    ...
                    __spreadValues({
                      appearance: "text",
                      icon: brand || /* @__PURE__ */ jsx32(MaterialIcon, { icon: "home" }),
                      href: homeURL,
                      element
                    }, backAttr)
                  ),
                  /* @__PURE__ */ jsx32(
                    ...
                    {
                      appearance: "text",
                      icon: /* @__PURE__ */ jsx32(MaterialIcon, { icon: "menu" }),
                      onClick: onNavToggle
                    }
                  )
                ] })
...
function Switch({
  ...
  return /* @__PURE__ */ jsx34(
    ...
    __spreadProps(__spreadValues({
      ...
      children: /* @__PURE__ */ jsx34("div", { className: "skc-switch__handle", children: value ? onIcon : offIcon })
    })
  );
}
  ...
  return /* @__PURE__ */ jsxs22(
    "label",
    {
      ...
      children: [
        ...
        leading && /* @__PURE__ */ jsx35(motion17.div, { className: "skc-text-field__leading", children: leading }),
        behavior === "single-line" ? /* @__PURE__ */ jsx35("input", __spreadValues(__spreadValues({}, inputProps), inputAttr)) : /* @__PURE__ */ jsx35("textarea", __spreadValues({ ref: textareaRef }, inputProps)),
        /* @__PURE__ */ jsx35(LayoutGroup3, { children: /* @__PURE__ */ jsxs22(AnimatePresence9, { initial: false, children: [
          trailing && /* @__PURE__ */ jsx35(
            motion17.div,
            {
          ...
          (canClear || error) && /* @__PURE__ */ jsx35(
            motion17.div,
            {
              ...
              transition: fieldTransition,
              className: "skc-text-field__trailing",
              children: canClear ? /* @__PURE__ */ jsx35(
                Button,
                {
                  appearance: "text",
                  icon: /* @__PURE__ */ jsx35(MaterialIcon, { icon: "cancel" }),
                  disabled,
                  onClick: () => onChange && onChange("")
                }
              ) : error ? /* @__PURE__ */ jsx35(MaterialIcon, { icon: "error", fill: true }) : null
            }
          )
        ] }) }),
        helperMsg && /* @__PURE__ */ jsx35("span", { id: `${fieldID}-helper`, className: "skc-text-field__helper-msg", children: helperMsg })
      ]
    }
  );
}
...
import { Fragment as Fragment13, jsx as jsx36 } from "react/jsx-runtime";
function ThemeProvider({ children }) {
  return /* @__PURE__ */ jsx36(Fragment13, { children });
}
