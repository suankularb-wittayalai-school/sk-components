...
function NavDrawer({
  ...
  return /* @__PURE__ */ jsx9(AnimatePresence2, {
    children: open && /* @__PURE__ */ jsxs6(Fragment4, {
      children: [
        /* @__PURE__ */ jsx9(motion6.aside, {
          ...
          children: /* @__PURE__ */ jsx9("nav", {
            children
          })
        }),
        /* @__PURE__ */ jsx9(motion6.div, {
          initial: { opacity: 0 },
          animate: { opacity: 0.5 },
          exit: {
            opacity: 0,
...
function NavDrawerItem({
  ...
  const content = /* @__PURE__ */ jsxs8(Fragment5, {
    children: [
      ...
      metadata && /* @__PURE__ */ jsx11("span", {
        className: "skc-nav-drawer-item__metadata",
        children: metadata
      }),
      /* @__PURE__ */ jsx11(motion7.span, {
        initial: { scale: 0, opacity: 0.36 },
        animate: rippleControls,
  ...
  return /* @__PURE__ */ jsx11("li", {
    children: Element ? /* @__PURE__ */ jsx11(Element, {
      ...props,
      children: content
    }) : /* @__PURE__ */ jsx11("a", {
      ...props,
...
function FAB({
  ...
  const content = /* @__PURE__ */ jsx12(AnimatePresence3, {
    initial: false,
    children: !(stateOnScroll === "disappear" && canHide && scrollDir === "down") && /* @__PURE__ */ jsxs9(motion8.div, {
      ...
      children: [
        icon && /* @__PURE__ */ jsx12("div", {
          className: "skc-fab__icon",
          children: icon
        }),
        !(stateOnScroll === "minimize" && !(scrollDir === "up")) && children && /* @__PURE__ */ jsx12("span", {
          className: "skc-fab__label",
          children
        }),
        /* @__PURE__ */ jsx12(motion8.span, {
          initial: { scale: 0, opacity: 0.36 },
          animate: rippleControls,
  ...
  return href && Element ? /* @__PURE__ */ jsx12(Element, {
    ...props,
    href,
    children: content
  }) : href ? /* @__PURE__ */ jsx12("a", {
    href,
    ...props,
    children: content
...
// src/components/PageHeader/index.tsx
import { AnimatePresence as AnimatePresence4, LayoutGroup as LayoutGroup2, motion as motion9 } from "framer-motion";
...
function PageHeader({
  ...
  const [hideIcon, setHideIcon] = React10.useState(false);
  React10.useEffect(() => {
  ...
  return /* @__PURE__ */ jsxs10(Fragment6, {
    children: [
      ...
      /* @__PURE__ */ jsx15(LayoutGroup2, {
        children: /* @__PURE__ */ jsx15(AnimatePresence4, {
          children: /* @__PURE__ */ jsx15("header", {
            ref: headerRef,
            style,
            className: cn([
              "skc-page-header",
            ...
            children: /* @__PURE__ */ jsxs10("div", {
              ...
              children: [
                icon && !children && !hideIcon && /* @__PURE__ */ jsx15(motion9.div, {
                ...
                /* @__PURE__ */ jsxs10(motion9.div, {
                  ...
                  children: [
                    /* @__PURE__ */ jsx15(Button, {
                      appearance: "text",
                      icon: /* @__PURE__ */ jsx15(MaterialIcon, {
                        icon: "arrow_backward"
                      }),
                      onClick: onBack,
                      href: parentURL,
                    ...
                    minimized && /* @__PURE__ */ jsx15(motion9.h1, {
                    ...
                    /* @__PURE__ */ jsxs10("div", {
                      ...
                      children: [
                        homeURL && /* @__PURE__ */ jsx15(Button, {
                          appearance: "text",
                          icon: brand || /* @__PURE__ */ jsx15(MaterialIcon, {
                            icon: "home"
                          }),
                          href: homeURL,
                          element,
