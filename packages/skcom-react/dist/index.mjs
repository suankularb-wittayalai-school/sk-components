...
function AssistChip({
  ...
  const content = /* @__PURE__ */ jsxs4(Fragment3, { children: [
    icon && /* @__PURE__ */ jsx8("div", { className: "skc-assist-chip__icon", children: icon }),
    /* @__PURE__ */ jsx8("span", { className: "skc-assist-chip__label", children }),
    /* @__PURE__ */ jsx8(
      motion5.span,
      {
        initial: { scale: 0, opacity: 0.36 },
  ...
  return (
    ...
    href && Element ? /* @__PURE__ */ jsx8(Element, __spreadProps(__spreadValues({}, props), { href, children: content })) : (
      // Render an `<a>` if link passed in
      href ? /* @__PURE__ */ jsx8("a", __spreadProps(__spreadValues({}, props), { href, children: content })) : (
        // Otherwise, render a `<button>`
        /* @__PURE__ */ jsx8("button", __spreadProps(__spreadValues({}, props), { type: "button", children: content }))
      )
    )
  );
}
...
function Divider({ style, className }) {
  return /* @__PURE__ */ jsx9("hr", { style, className: cn(["skc-divider", className]) });
}
...
function Header({
  ...
  const content = /* @__PURE__ */ jsxs5(Fragment4, { children: [
    icon && /* @__PURE__ */ jsx10("span", { className: "skc-header__icon", children: icon }),
    /* @__PURE__ */ jsx10("span", { className: "skc-header__text", children })
  ] });
  return level === 6 ? /* @__PURE__ */ jsx10("h6", __spreadProps(__spreadValues({}, props), { children: content })) : level === 5 ? /* @__PURE__ */ jsx10("h5", __spreadProps(__spreadValues({}, props), { children: content })) : level === 4 ? /* @__PURE__ */ jsx10("h4", __spreadProps(__spreadValues({}, props), { children: content })) : level === 3 ? /* @__PURE__ */ jsx10("h3", __spreadProps(__spreadValues({}, props), { children: content })) : /* @__PURE__ */ jsx10("h2", __spreadProps(__spreadValues({}, props), { children: content }));
}
...
function NavBar({
  ...
  return /* @__PURE__ */ jsxs6("nav", { style, className: cn(["skc-nav-bar", className]), children: [
    /* @__PURE__ */ jsxs6("div", { className: "skc-nav-bar__main", children: [
      /* @__PURE__ */ jsxs6("section", { className: "skc-nav-bar__toggle-and-fab", children: [
        /* @__PURE__ */ jsx11(
          Button,
          {
            appearance: "text",
            icon: /* @__PURE__ */ jsx11(MaterialIcon, { icon: "menu" }),
            alt: locale === "th" ? "\u0E40\u0E1B\u0E34\u0E14\u0E40\u0E21\u0E19\u0E39" : "Toggle Navigation Drawer",
            onClick: onNavToggle
          }
        ),
        /* @__PURE__ */ jsx11("div", { className: "skc-nav-bar__brand", children: brand }),
        fab
      ] }),
      /* @__PURE__ */ jsx11("section", { className: "skc-nav-bar__destinations", children })
    ] }),
    /* @__PURE__ */ jsx11("section", { className: "skc-nav-bar__end", children: end })
  ] });
}
...
function NavBarItem({
  ...
  const content = /* @__PURE__ */ jsxs7(Fragment5, { children: [
    /* @__PURE__ */ jsxs7("div", { ref: iconRef, className: "skc-nav-bar-item__icon", children: [
      icon,
      /* @__PURE__ */ jsx12(LayoutGroup, { children: /* @__PURE__ */ jsx12(AnimatePresence, { children: badge !== void 0 && /* @__PURE__ */ jsx12(
        motion6.div,
        {
          initial: { scale: 0 },
          animate: { scale: 1 },
    ...
    label && /* @__PURE__ */ jsx12("span", { id: navID, className: "skc-nav-bar-item__label", children: label })
  ] });
  return (
    // Render with `element` if defined
    Element ? /* @__PURE__ */ jsx12(Element, __spreadProps(__spreadValues({}, props), { children: content })) : (
      // Otherwise, render an `<a>`
      /* @__PURE__ */ jsx12("a", __spreadProps(__spreadValues({}, props), { children: content }))
    )
  );
}
...
function NavDrawer({
  ...
  return /* @__PURE__ */ jsx13(AnimatePresence2, { children: open && /* @__PURE__ */ jsxs8(Fragment6, { children: [
    /* @__PURE__ */ jsx13(
      motion7.aside,
      {
        ...
        children: /* @__PURE__ */ jsx13("nav", { children: injectedChildren })
      }
    ),
    /* @__PURE__ */ jsx13(
      motion7.div,
...
function NavDrawerItem({
  ...
  const content = /* @__PURE__ */ jsxs10(Fragment7, { children: [
    /* @__PURE__ */ jsx15("div", { className: "skc-nav-drawer-item__icon", children: icon }),
    /* @__PURE__ */ jsx15("span", { className: "skc-nav-drawer-item__label", children: label }),
    metadata && /* @__PURE__ */ jsx15("span", { className: "skc-nav-drawer-item__metadata", children: metadata }),
    /* @__PURE__ */ jsx15(
      motion8.span,
      {
        initial: { scale: 0, opacity: 0.36 },
  ...
  return /* @__PURE__ */ jsx15("li", { children: Element ? /* @__PURE__ */ jsx15(Element, __spreadProps(__spreadValues({}, props), { children: content })) : /* @__PURE__ */ jsx15("a", __spreadProps(__spreadValues({}, props), { children: content })) });
}
...
function FAB({
  ...
  const content = /* @__PURE__ */ jsx16(AnimatePresence3, {
    initial: false,
    // Hide the FAB on scroll if `stateOnScroll` set to `disappear`
    children: !(stateOnScroll === "disappear" && canHide && scrollDir === "down") && /* @__PURE__ */ jsxs11(
      motion9.div,
      {
        ref: fabRef,
        ...
        children: [
          icon && /* @__PURE__ */ jsx16("div", { className: "skc-fab__icon", children: icon }),
          // Hide the label on scroll if `stateOnScroll` set to `minimize`
          !(stateOnScroll === "minimize" && !(scrollDir === "up")) && children && /* @__PURE__ */ jsx16("span", { className: "skc-fab__label", children }),
          /* @__PURE__ */ jsx16(
            motion9.span,
            {
              initial: { scale: 0, opacity: 0.36 },
  ...
  return (
    // Render with `element` if defined
    href && Element ? /* @__PURE__ */ jsx16(Element, __spreadProps(__spreadValues({}, props), { href, children: content })) : (
      // Render an `<a>` if link passed in
      href ? /* @__PURE__ */ jsx16("a", __spreadProps(__spreadValues({ href }, props), { children: content })) : (
        // Otherwise, render a `<button>`
        /* @__PURE__ */ jsx16("button", __spreadProps(__spreadValues({ type: "button", onClick }, props), { children: content }))
      )
    )
  );
}
...
function ContentLayout({
  ...
  return /* @__PURE__ */ jsx17(
    motion10.main,
    {
      ...
      children: /* @__PURE__ */ jsx17("div", { className: "skc-content-layout__content", children })
    }
  );
}
...
function RootLayout({ children, className, style }) {
  ...
  return /* @__PURE__ */ jsxs12("div", { style, className: cn(["skc-root-layout", className]), children: [
...
function PageHeader({
  ...
  return /* @__PURE__ */ jsxs13(Fragment8, { children: [
    /* @__PURE__ */ jsx19("div", { className: "skc-page-header__replacement-color" }),
    /* @__PURE__ */ jsx19(
      "div",
      {
    ...
    /* @__PURE__ */ jsx19(LayoutGroup2, { children: /* @__PURE__ */ jsx19(
      motion11.header,
      {
        ref: headerRef,
        ...
        children: /* @__PURE__ */ jsxs13("div", { className: "skc-page-header__content", children: [
          icon && !children && /* @__PURE__ */ jsx19(
            motion11.div,
            {
            ...
            motion11.div,
            {
              ...
              children: [
                /* @__PURE__ */ jsx19(
                  ...
                  {
                    appearance: "text",
                    icon: /* @__PURE__ */ jsx19(MaterialIcon, { icon: "arrow_backward" }),
                    onClick: onBack,
                    href: parentURL,
                    element,
                ...
                /* @__PURE__ */ jsx19(motion11.h1, __spreadProps(__spreadValues({}, headerTextProps), { children: title })),
                /* @__PURE__ */ jsxs13("div", { className: "skc-page-header__trailing", children: [
                  homeURL && // Home Button
                  /* @__PURE__ */ jsx19(
                    Button,
                    __spreadValues({
                      appearance: "text",
                      icon: brand || /* @__PURE__ */ jsx19(MaterialIcon, { icon: "home" }),
                      href: homeURL,
                      element
                    }, backAttr)
                  ),
...
function ThemeProvider({ children }) {
  return /* @__PURE__ */ jsx21(Fragment9, { children });
}
