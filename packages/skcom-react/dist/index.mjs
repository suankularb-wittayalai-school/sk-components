...
function Divider({ style, className }) {
  return /* @__PURE__ */ jsx12("hr", { style, className: cn(["skc-divider", className]) });
}
...
function Header({
  ...
  const content = /* @__PURE__ */ jsxs7(Fragment5, { children: [
    icon && /* @__PURE__ */ jsx13("span", { className: "skc-header__icon", children: icon }),
    /* @__PURE__ */ jsx13("span", { className: "skc-header__text", children })
  ] });
  return level === 6 ? /* @__PURE__ */ jsx13("h6", __spreadProps(__spreadValues({}, props), { children: content })) : level === 5 ? /* @__PURE__ */ jsx13("h5", __spreadProps(__spreadValues({}, props), { children: content })) : level === 4 ? /* @__PURE__ */ jsx13("h4", __spreadProps(__spreadValues({}, props), { children: content })) : level === 3 ? /* @__PURE__ */ jsx13("h3", __spreadProps(__spreadValues({}, props), { children: content })) : /* @__PURE__ */ jsx13("h2", __spreadProps(__spreadValues({}, props), { children: content }));
}
...
function List({
  ...
  return /* @__PURE__ */ jsx14(
    "ul",
    {
      ...
      children: columns ? /* @__PURE__ */ jsx14(Columns, { columns, children }) : children
    }
  );
}
...
// src/components/ListItem/index.tsx
import { Fragment as Fragment6, jsx as jsx15, jsxs as jsxs8 } from "react/jsx-runtime";
function ListItem({
  children,
  align,
  lines,
  ...
  const content = /* @__PURE__ */ jsxs8(Fragment6, { children: [
    children,
    stateLayerEffect && /* @__PURE__ */ jsx15(
      motion7.span,
      {
        initial: { scale: 0, opacity: 0.36 },
        animate: rippleControls,
  ...
  return (
    ...
    href || onClick || stateLayerEffect ? /* @__PURE__ */ jsx15("li", {
      "aria-labelledby": itemID,
      // Render with `element` if defined
      children: href && Element ? /* @__PURE__ */ jsx15(Element, __spreadProps(__spreadValues({}, props), { href, children: content })) : (
        // Render an `<a>` if link passed in
        href ? /* @__PURE__ */ jsx15("a", __spreadProps(__spreadValues({}, props), { href, children: content })) : (
          // Otherwise, render a `<button>`
          /* @__PURE__ */ jsx15("button", __spreadProps(__spreadValues({}, __spreadProps(__spreadValues({}, props), { onClick })), { type: "button", children: content }))
        )
      )
    }) : (
      // If this Item has no functionality, just render a `<li>`
      /* @__PURE__ */ jsx15("li", __spreadProps(__spreadValues({}, props), { children: content }))
    )
  );
}
...
function ListItemContent({
  ...
  return /* @__PURE__ */ jsxs9("div", { style, className: cn(["skc-list-item-content", className]), children: [
    overline && /* @__PURE__ */ jsx16("span", { className: "skc-list-item-content__overline", children: overline }),
    /* @__PURE__ */ jsx16(
      "span",
      {
    ...
    desc && /* @__PURE__ */ jsx16("span", { className: "skc-list-item-content__desc", children: desc })
  ] });
}
...
function NavBar({
  ...
  return /* @__PURE__ */ jsxs10("nav", { style, className: cn(["skc-nav-bar", className]), children: [
    /* @__PURE__ */ jsxs10("div", { className: "skc-nav-bar__main", children: [
      /* @__PURE__ */ jsxs10("section", { className: "skc-nav-bar__toggle-and-fab", children: [
        /* @__PURE__ */ jsx17(
          Button,
          {
            appearance: "text",
        ...
        /* @__PURE__ */ jsx17("div", { className: "skc-nav-bar__brand", children: brand }),
        fab
      ] }),
      /* @__PURE__ */ jsx17("section", { className: "skc-nav-bar__destinations", children })
    ] }),
    /* @__PURE__ */ jsx17("section", { className: "skc-nav-bar__end", children: end })
  ] });
}
NavBar.displayName = "NavBar";

// src/components/NavBarItem/index.tsx
import { AnimatePresence as AnimatePresence2, LayoutGroup, motion as motion8 } from "framer-motion";
...
function NavBarItem({
  ...
  const content = /* @__PURE__ */ jsxs11(Fragment7, { children: [
    /* @__PURE__ */ jsxs11("div", { ref: iconRef, className: "skc-nav-bar-item__icon", children: [
      icon,
      /* @__PURE__ */ jsx18(LayoutGroup, { children: /* @__PURE__ */ jsx18(AnimatePresence2, { children: badge !== void 0 && /* @__PURE__ */ jsx18(
        motion8.div,
        {
          initial: { scale: 0 },
          animate: { scale: 1 },
    ...
    label && /* @__PURE__ */ jsx18("span", { id: navID, className: "skc-nav-bar-item__label", children: label })
  ] });
  return (
    // Render with `element` if defined
    Element ? /* @__PURE__ */ jsx18(Element, __spreadProps(__spreadValues({}, props), { children: content })) : (
      // Otherwise, render an `<a>`
      /* @__PURE__ */ jsx18("a", __spreadProps(__spreadValues({}, props), { children: content }))
    )
  );
}
...
// src/components/NavDrawer/index.tsx
import { Fragment as Fragment8, jsx as jsx19, jsxs as jsxs12 } from "react/jsx-runtime";
function NavDrawer({
  children,
  open,
  onClose,
  ...
  return /* @__PURE__ */ jsx19(AnimatePresence3, { children: open && /* @__PURE__ */ jsxs12(Fragment8, { children: [
    /* @__PURE__ */ jsx19(
      motion9.aside,
      {
        ...
        children: /* @__PURE__ */ jsx19("nav", { children: injectedChildren })
      }
    ),
    /* @__PURE__ */ jsx19(
      motion9.div,
...
function NavDrawerItem({
  ...
  const content = /* @__PURE__ */ jsxs14(Fragment9, { children: [
    /* @__PURE__ */ jsx21("div", { className: "skc-nav-drawer-item__icon", children: icon }),
    /* @__PURE__ */ jsx21("span", { className: "skc-nav-drawer-item__label", children: label }),
    metadata && /* @__PURE__ */ jsx21("span", { className: "skc-nav-drawer-item__metadata", children: metadata }),
    /* @__PURE__ */ jsx21(
      motion10.span,
      {
        initial: { scale: 0, opacity: 0.36 },
  ...
  return /* @__PURE__ */ jsx21("li", { children: Element ? /* @__PURE__ */ jsx21(Element, __spreadProps(__spreadValues({}, props), { children: content })) : /* @__PURE__ */ jsx21("a", __spreadProps(__spreadValues({}, props), { children: content })) });
}
NavDrawerItem.displayName = "NavDrawerItem";

// src/components/FAB/index.tsx
import { AnimatePresence as AnimatePresence4, motion as motion11 } from "framer-motion";
...
function FAB({
  ...
  const content = /* @__PURE__ */ jsx22(AnimatePresence4, {
    initial: false,
    // Hide the FAB on scroll if `stateOnScroll` set to `disappear`
    children: !(stateOnScroll === "disappear" && canHide && scrollDir === "down") && /* @__PURE__ */ jsxs15(
      motion11.div,
      {
        ref: fabRef,
        ...
        children: [
          icon && /* @__PURE__ */ jsx22("div", { className: "skc-fab__icon", children: icon }),
          // Hide the label on scroll if `stateOnScroll` set to `minimize`
          !(stateOnScroll === "minimize" && !(scrollDir === "up")) && children && /* @__PURE__ */ jsx22("span", { className: "skc-fab__label", children }),
          /* @__PURE__ */ jsx22(
            motion11.span,
            {
              initial: { scale: 0, opacity: 0.36 },
  ...
  return (
    // Render with `element` if defined
    href && Element ? /* @__PURE__ */ jsx22(Element, __spreadProps(__spreadValues({}, props), { href, children: content })) : (
      // Render an `<a>` if link passed in
      href ? /* @__PURE__ */ jsx22("a", __spreadProps(__spreadValues({ href }, props), { children: content })) : (
        // Otherwise, render a `<button>`
        /* @__PURE__ */ jsx22("button", __spreadProps(__spreadValues({ type: "button", onClick }, props), { children: content }))
      )
    )
  );
}
...
function ContentLayout({
  ...
  return /* @__PURE__ */ jsx23(
    motion12.main,
    {
      ...
      children: /* @__PURE__ */ jsx23("div", { className: "skc-content-layout__content", children })
    }
  );
}
...
function RootLayout({ children, className, style }) {
  ...
  return /* @__PURE__ */ jsxs16("div", { style, className: cn(["skc-root-layout", className]), children: [
...
function PageHeader({
  ...
  return /* @__PURE__ */ jsxs17(Fragment10, { children: [
    /* @__PURE__ */ jsx25("div", { className: "skc-page-header__replacement-color" }),
    /* @__PURE__ */ jsx25(
      "div",
      {
    ...
    /* @__PURE__ */ jsx25(LayoutGroup2, { children: /* @__PURE__ */ jsx25(
      motion13.header,
      {
        ref: headerRef,
        ...
        children: /* @__PURE__ */ jsxs17("div", { className: "skc-page-header__content", children: [
          icon && !children && /* @__PURE__ */ jsx25(
            motion13.div,
            {
            ...
            motion13.div,
            {
              ...
              children: [
                /* @__PURE__ */ jsx25(
                  ...
                  {
                    appearance: "text",
                    icon: /* @__PURE__ */ jsx25(MaterialIcon, { icon: "arrow_backward" }),
                    onClick: onBack,
                    href: parentURL,
                    element,
                ...
                /* @__PURE__ */ jsx25(motion13.h1, __spreadProps(__spreadValues({}, headerTextProps), { children: title })),
                /* @__PURE__ */ jsxs17("div", { className: "skc-page-header__trailing", children: [
                  homeURL && // Home Button
                  /* @__PURE__ */ jsx25(
                    Button,
                    __spreadValues({
                      appearance: "text",
                      icon: brand || /* @__PURE__ */ jsx25(MaterialIcon, { icon: "home" }),
                      href: homeURL,
                      element
                    }, backAttr)
                  ),
...
import { Fragment as Fragment11, jsx as jsx27 } from "react/jsx-runtime";
function ThemeProvider({ children }) {
  return /* @__PURE__ */ jsx27(Fragment11, { children });
}
