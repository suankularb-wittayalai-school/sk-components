...
function Divider({ style, className }) {
  return /* @__PURE__ */ jsx11("hr", { style, className: cn(["skc-divider", className]) });
}
...
function Header({
  ...
  const content = /* @__PURE__ */ jsxs6(Fragment4, { children: [
    icon && /* @__PURE__ */ jsx12("span", { className: "skc-header__icon", children: icon }),
    /* @__PURE__ */ jsx12("span", { className: "skc-header__text", children })
  ] });
  return level === 6 ? /* @__PURE__ */ jsx12("h6", __spreadProps(__spreadValues({}, props), { children: content })) : level === 5 ? /* @__PURE__ */ jsx12("h5", __spreadProps(__spreadValues({}, props), { children: content })) : level === 4 ? /* @__PURE__ */ jsx12("h4", __spreadProps(__spreadValues({}, props), { children: content })) : level === 3 ? /* @__PURE__ */ jsx12("h3", __spreadProps(__spreadValues({}, props), { children: content })) : /* @__PURE__ */ jsx12("h2", __spreadProps(__spreadValues({}, props), { children: content }));
}
...
function List({
  ...
  return /* @__PURE__ */ jsx13(
    "ul",
    {
      ...
      children: columns ? /* @__PURE__ */ jsx13(Columns, { columns, children }) : children
    }
  );
}
...
function ListItem({
  ...
  const content = /* @__PURE__ */ jsxs7(Fragment5, { children: [
    children,
    stateLayerEffect && /* @__PURE__ */ jsx14(
      motion6.span,
      {
        initial: { scale: 0, opacity: 0.36 },
        animate: rippleControls,
  ...
  return (
    ...
    href || onClick || stateLayerEffect ? /* @__PURE__ */ jsx14("li", {
      "aria-labelledby": itemID,
      // Render with `element` if defined
      children: href && Element ? /* @__PURE__ */ jsx14(Element, __spreadProps(__spreadValues({}, props), { href, children: content })) : (
        // Render an `<a>` if link passed in
        href ? /* @__PURE__ */ jsx14("a", __spreadProps(__spreadValues({}, props), { href, children: content })) : (
          // Otherwise, render a `<button>`
          /* @__PURE__ */ jsx14("button", __spreadProps(__spreadValues({}, __spreadProps(__spreadValues({}, props), { onClick })), { type: "button", children: content }))
        )
      )
    }) : (
      // If this Item has no functionality, just render a `<li>`
      /* @__PURE__ */ jsx14("li", __spreadProps(__spreadValues({}, props), { children: content }))
    )
  );
}
...
function ListItemContent({
  ...
  return /* @__PURE__ */ jsxs8("div", { style, className: cn(["skc-list-item-content", className]), children: [
    overline && /* @__PURE__ */ jsx15("span", { className: "skc-list-item-content__overline", children: overline }),
    /* @__PURE__ */ jsx15(
      "span",
      {
    ...
    desc && /* @__PURE__ */ jsx15("span", { className: "skc-list-item-content__desc", children: desc })
  ] });
}
...
function NavBar({
  ...
  return /* @__PURE__ */ jsxs9("nav", { style, className: cn(["skc-nav-bar", className]), children: [
    /* @__PURE__ */ jsxs9("div", { className: "skc-nav-bar__main", children: [
      /* @__PURE__ */ jsxs9("section", { className: "skc-nav-bar__toggle-and-fab", children: [
        /* @__PURE__ */ jsx16(
          Button,
          {
            appearance: "text",
            icon: /* @__PURE__ */ jsx16(MaterialIcon, { icon: "menu" }),
            alt: locale === "th" ? "\u0E40\u0E1B\u0E34\u0E14\u0E40\u0E21\u0E19\u0E39" : "Toggle Navigation Drawer",
            onClick: onNavToggle
          }
        ),
        /* @__PURE__ */ jsx16("div", { className: "skc-nav-bar__brand", children: brand }),
        fab
      ] }),
      /* @__PURE__ */ jsx16("section", { className: "skc-nav-bar__destinations", children })
    ] }),
    /* @__PURE__ */ jsx16("section", { className: "skc-nav-bar__end", children: end })
  ] });
}
NavBar.displayName = "NavBar";

// src/components/NavBarItem/index.tsx
import { AnimatePresence, LayoutGroup, motion as motion7 } from "framer-motion";
...
function NavBarItem({
  ...
  const { duration, easing } = useAnimationConfig();
  const iconRef = React8.useRef(null);
  const [clientHeight, setClientHeight] = React8.useState(1080);
  React8.useEffect(() => {
  ...
  const content = /* @__PURE__ */ jsxs10(Fragment6, { children: [
    /* @__PURE__ */ jsxs10("div", { ref: iconRef, className: "skc-nav-bar-item__icon", children: [
      icon,
      /* @__PURE__ */ jsx17(LayoutGroup, { children: /* @__PURE__ */ jsx17(AnimatePresence, { children: badge !== void 0 && /* @__PURE__ */ jsx17(
        motion7.div,
        {
          initial: { scale: 0 },
          animate: { scale: 1 },
    ...
    label && /* @__PURE__ */ jsx17("span", { id: navID, className: "skc-nav-bar-item__label", children: label })
  ] });
  return (
    // Render with `element` if defined
    Element ? /* @__PURE__ */ jsx17(Element, __spreadProps(__spreadValues({}, props), { children: content })) : (
      // Otherwise, render an `<a>`
      /* @__PURE__ */ jsx17("a", __spreadProps(__spreadValues({}, props), { children: content }))
    )
  );
}
...
// src/components/NavDrawer/index.tsx
import { Fragment as Fragment7, jsx as jsx18, jsxs as jsxs11 } from "react/jsx-runtime";
function NavDrawer({
  children,
  open,
  onClose,
  ...
  const injectedChildren = (
    ...
    React9.Children.map(
      children,
      (section) => React9.cloneElement(section, {
        children: (
          ...
          React9.Children.map(
            ...
            (item) => React9.cloneElement(item, { onClick: onClose })
          )
        )
      })
    )
  );
  return /* @__PURE__ */ jsx18(AnimatePresence2, { children: open && /* @__PURE__ */ jsxs11(Fragment7, { children: [
    /* @__PURE__ */ jsx18(
      motion8.aside,
      {
        ...
        children: /* @__PURE__ */ jsx18("nav", { children: injectedChildren })
      }
    ),
    /* @__PURE__ */ jsx18(
      motion8.div,
...
function NavDrawerItem({
  ...
  const linkRef = React10.useRef(null);
  ...
  const content = /* @__PURE__ */ jsxs13(Fragment8, { children: [
    /* @__PURE__ */ jsx20("div", { className: "skc-nav-drawer-item__icon", children: icon }),
    /* @__PURE__ */ jsx20("span", { className: "skc-nav-drawer-item__label", children: label }),
    metadata && /* @__PURE__ */ jsx20("span", { className: "skc-nav-drawer-item__metadata", children: metadata }),
    /* @__PURE__ */ jsx20(
      motion9.span,
      {
        initial: { scale: 0, opacity: 0.36 },
  ...
  return /* @__PURE__ */ jsx20("li", { children: Element ? /* @__PURE__ */ jsx20(Element, __spreadProps(__spreadValues({}, props), { children: content })) : /* @__PURE__ */ jsx20("a", __spreadProps(__spreadValues({}, props), { children: content })) });
}
...
function FAB({
  ...
  const { duration, easing } = useAnimationConfig();
  const fabRef = React12.useRef(null);
  const { rippleListeners, rippleControls, rippleStyle } = useRipple(fabRef);
  const { scrollDir } = useScrollDirection();
  const [canHide, setCanHide] = React12.useState(false);
  React12.useEffect(() => {
    if (stateOnScroll) {
  ...
  const content = /* @__PURE__ */ jsx21(AnimatePresence3, {
    initial: false,
    // Hide the FAB on scroll if `stateOnScroll` set to `disappear`
    children: !(stateOnScroll === "disappear" && canHide && scrollDir === "down") && /* @__PURE__ */ jsxs14(
      motion10.div,
      {
        ref: fabRef,
        ...
        children: [
          icon && /* @__PURE__ */ jsx21("div", { className: "skc-fab__icon", children: icon }),
          // Hide the label on scroll if `stateOnScroll` set to `minimize`
          !(stateOnScroll === "minimize" && !(scrollDir === "up")) && children && /* @__PURE__ */ jsx21("span", { className: "skc-fab__label", children }),
          /* @__PURE__ */ jsx21(
            motion10.span,
            {
              initial: { scale: 0, opacity: 0.36 },
  ...
  return (
    // Render with `element` if defined
    href && Element ? /* @__PURE__ */ jsx21(Element, __spreadProps(__spreadValues({}, props), { href, children: content })) : (
      // Render an `<a>` if link passed in
      href ? /* @__PURE__ */ jsx21("a", __spreadProps(__spreadValues({ href }, props), { children: content })) : (
        // Otherwise, render a `<button>`
        /* @__PURE__ */ jsx21("button", __spreadProps(__spreadValues({ type: "button", onClick }, props), { children: content }))
      )
    )
  );
}
...
function ContentLayout({
  ...
  return /* @__PURE__ */ jsx22(
    motion11.main,
    {
      ...
      children: /* @__PURE__ */ jsx22("div", { className: "skc-content-layout__content", children })
    }
  );
}
...
function RootLayout({ children, className, style }) {
  let content;
  const persistentComponents = React13.Children.map(children, (child) => {
    if (child == null ? void 0 : child.type.displayName)
      return child;
    else
      content = child;
  });
  return /* @__PURE__ */ jsxs15("div", { style, className: cn(["skc-root-layout", className]), children: [
...
// src/components/PageHeader/index.tsx
import { Fragment as Fragment9, jsx as jsx24, jsxs as jsxs16 } from "react/jsx-runtime";
function PageHeader({
  children,
  title,
  icon,
  ...
  const [minimized, setMinimized] = React14.useState(false);
  React14.useEffect(() => {
  ...
  return /* @__PURE__ */ jsxs16(Fragment9, { children: [
    /* @__PURE__ */ jsx24("div", { className: "skc-page-header__replacement-color" }),
    /* @__PURE__ */ jsx24(
      "div",
      {
    ...
    /* @__PURE__ */ jsx24(LayoutGroup2, { children: /* @__PURE__ */ jsx24(
      motion12.header,
      {
        ref: headerRef,
        ...
        children: /* @__PURE__ */ jsxs16("div", { className: "skc-page-header__content", children: [
          icon && !children && /* @__PURE__ */ jsx24(
            motion12.div,
            {
            ...
            motion12.div,
            {
              ...
              children: [
                /* @__PURE__ */ jsx24(
                  ...
                  {
                    appearance: "text",
                    icon: /* @__PURE__ */ jsx24(MaterialIcon, { icon: "arrow_backward" }),
                    onClick: onBack,
                    href: parentURL,
                    element,
                ...
                /* @__PURE__ */ jsx24(motion12.h1, __spreadProps(__spreadValues({}, headerTextProps), { children: title })),
                /* @__PURE__ */ jsxs16("div", { className: "skc-page-header__trailing", children: [
                  homeURL && // Home Button
                  /* @__PURE__ */ jsx24(
                    Button,
                    __spreadValues({
                      appearance: "text",
                      icon: brand || /* @__PURE__ */ jsx24(MaterialIcon, { icon: "home" }),
                      href: homeURL,
                      element
                    }, backAttr)
                  ),
...
import { Fragment as Fragment10, jsx as jsx26 } from "react/jsx-runtime";
function ThemeProvider({ children }) {
  return /* @__PURE__ */ jsx26(Fragment10, { children });
}
