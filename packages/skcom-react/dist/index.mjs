...
function Section({
  ...
  const modifiedChildren = (
    ...
    React21.Children.map(children, (child) => {
...
function Switch({
  ...
  return /* @__PURE__ */ jsx36(
    ...
    __spreadProps(__spreadValues({
      ...
      children: /* @__PURE__ */ jsx36("div", { className: "skc-switch__handle", children: value ? onIcon : offIcon })
    })
  );
}
...
function TextField({
  ...
  const [minifyLabel, setMinifyLabel] = React22.useState();
  const [neverResetLabel, setNeverMinifyLabel] = React22.useState(false);
  ...
  React22.useEffect(() => expandTextarea, [value]);
  const [error, setError] = React22.useState(false);
  React22.useEffect(() => setError(Boolean(incError)), [incError]);
  ...
  return /* @__PURE__ */ jsxs24(
    "label",
    {
      ...
      children: [
        ...
        leading && /* @__PURE__ */ jsx37(motion19.div, { className: "skc-text-field__leading", children: leading }),
        behavior === "single-line" ? /* @__PURE__ */ jsx37("input", __spreadValues(__spreadValues({}, inputProps), inputAttr)) : /* @__PURE__ */ jsx37("textarea", __spreadValues({ ref: textareaRef }, inputProps)),
        /* @__PURE__ */ jsx37(LayoutGroup3, { children: /* @__PURE__ */ jsxs24(AnimatePresence9, { initial: false, children: [
          ...
          (canClear || error) && /* @__PURE__ */ jsx37(
            motion19.div,
            {
              ...
              transition: fieldTransition,
              className: "skc-text-field__trailing",
              children: canClear ? /* @__PURE__ */ jsx37(
                Button,
                {
                  appearance: "text",
                  icon: /* @__PURE__ */ jsx37(MaterialIcon, { icon: "cancel" }),
                  disabled,
                  onClick: () => onChange && onChange("")
                }
              ) : error ? /* @__PURE__ */ jsx37(MaterialIcon, { icon: "error", fill: true }) : null
            }
          )
        ] }) }),
        helperMsg && /* @__PURE__ */ jsx37("span", { id: `${fieldID}-helper`, className: "skc-text-field__helper-msg", children: helperMsg })
      ]
    }
  );
}
