...
styleInject(".skc-divider {\n  border: none;\n  border-top: 1px solid var(--outline-variant);\n}\n.skc-list {\n  display: flex;\n  flex-direction: column;\n  gap: .5rem 1.5rem;\n}\n.skc-list--divided > :not(:last-child),\n.skc-list--divided .skc-columns > :not(:last-child) {\n  padding-bottom: .5rem;\n  border-bottom: 1px solid var(--outline-variant);\n}\n");
    ...
    /* @__PURE__ */ jsxs7("div", { className: "skc-nav-bar__main", children: [
      /* @__PURE__ */ jsxs7("section", { className: "skc-nav-bar__toggle-and-fab", children: [
        /* @__PURE__ */ jsx14(
          ...
          {
            appearance: "text",
            icon: /* @__PURE__ */ jsx14(MaterialIcon, { icon: "menu" }),
            alt: locale === "th" ? "\u0E40\u0E1B\u0E34\u0E14\u0E40\u0E21\u0E19\u0E39" : "Toggle Navigation Drawer",
            onClick: onNavToggle
          }
        ),
        /* @__PURE__ */ jsx14("div", { className: "skc-nav-bar__brand", children: brand }),
        fab
      ] }),
      /* @__PURE__ */ jsx14("section", { className: "skc-nav-bar__destinations", children })
    ] }),
    /* @__PURE__ */ jsx14("section", { className: "skc-nav-bar__end", children: end })
  ] });
}
...
function NavBarItem({
  ...
  const content = /* @__PURE__ */ jsxs8(Fragment5, { children: [
    /* @__PURE__ */ jsxs8("div", { ref: iconRef, className: "skc-nav-bar-item__icon", children: [
      icon,
      /* @__PURE__ */ jsx15(LayoutGroup, { children: /* @__PURE__ */ jsx15(AnimatePresence, { children: badge !== void 0 && /* @__PURE__ */ jsx15(
        motion6.div,
        {
          initial: { scale: 0 },
          animate: { scale: 1 },
    ...
    label && /* @__PURE__ */ jsx15("span", { id: navID, className: "skc-nav-bar-item__label", children: label })
  ] });
  return (
    // Render with `element` if defined
    Element ? /* @__PURE__ */ jsx15(Element, __spreadProps(__spreadValues({}, props), { children: content })) : (
      // Otherwise, render an `<a>`
      /* @__PURE__ */ jsx15("a", __spreadProps(__spreadValues({}, props), { children: content }))
    )
  );
}
...
function NavDrawer({
  ...
  return /* @__PURE__ */ jsx16(AnimatePresence2, { children: open && /* @__PURE__ */ jsxs9(Fragment6, { children: [
    /* @__PURE__ */ jsx16(
      motion7.aside,
      {
        ...
        children: /* @__PURE__ */ jsx16("nav", { children: injectedChildren })
      }
    ),
    /* @__PURE__ */ jsx16(
      motion7.div,
...
function NavDrawerItem({
  ...
  const content = /* @__PURE__ */ jsxs11(Fragment7, { children: [
    /* @__PURE__ */ jsx18("div", { className: "skc-nav-drawer-item__icon", children: icon }),
    /* @__PURE__ */ jsx18("span", { className: "skc-nav-drawer-item__label", children: label }),
    metadata && /* @__PURE__ */ jsx18("span", { className: "skc-nav-drawer-item__metadata", children: metadata }),
    /* @__PURE__ */ jsx18(
      motion8.span,
      {
        initial: { scale: 0, opacity: 0.36 },
  ...
  return /* @__PURE__ */ jsx18("li", { children: Element ? /* @__PURE__ */ jsx18(Element, __spreadProps(__spreadValues({}, props), { children: content })) : /* @__PURE__ */ jsx18("a", __spreadProps(__spreadValues({}, props), { children: content })) });
}
...
function FAB({
  ...
  const content = /* @__PURE__ */ jsx19(AnimatePresence3, {
    initial: false,
    ...
    children: !(stateOnScroll === "disappear" && canHide && scrollDir === "down") && /* @__PURE__ */ jsxs12(
      motion9.div,
      {
        ...
        children: [
          icon && /* @__PURE__ */ jsx19("div", { className: "skc-fab__icon", children: icon }),
          // Hide the label on scroll if `stateOnScroll` set to `minimize`
          !(stateOnScroll === "minimize" && !(scrollDir === "up")) && children && /* @__PURE__ */ jsx19("span", { className: "skc-fab__label", children }),
          /* @__PURE__ */ jsx19(
            motion9.span,
            {
              initial: { scale: 0, opacity: 0.36 },
  ...
  return (
    // Render with `element` if defined
    href && Element ? /* @__PURE__ */ jsx19(Element, __spreadProps(__spreadValues({}, props), { href, children: content })) : (
      // Render an `<a>` if link passed in
      href ? /* @__PURE__ */ jsx19("a", __spreadProps(__spreadValues({ href }, props), { children: content })) : (
        // Otherwise, render a `<button>`
        /* @__PURE__ */ jsx19("button", __spreadProps(__spreadValues({ type: "button", onClick }, props), { children: content }))
      )
    )
  );
}
...
function ContentLayout({
  ...
  return /* @__PURE__ */ jsx20(
    motion10.main,
    {
      ...
      children: /* @__PURE__ */ jsx20("div", { className: "skc-content-layout__content", children })
    }
  );
}
...
function PageHeader({
  ...
  return /* @__PURE__ */ jsxs14(Fragment8, { children: [
    /* @__PURE__ */ jsx22("div", { className: "skc-page-header__replacement-color" }),
    /* @__PURE__ */ jsx22(
      "div",
      {
    ...
    /* @__PURE__ */ jsx22(LayoutGroup2, { children: /* @__PURE__ */ jsx22(
      motion11.header,
      {
        ref: headerRef,
            ...
            motion11.div,
            {
              ...
              children: [
                /* @__PURE__ */ jsx22(
                  ...
                  {
                    appearance: "text",
                    icon: /* @__PURE__ */ jsx22(MaterialIcon, { icon: "arrow_backward" }),
                    onClick: onBack,
                    href: parentURL,
                    element,
                ...
                /* @__PURE__ */ jsx22(motion11.h1, __spreadProps(__spreadValues({}, headerTextProps), { children: title })),
                /* @__PURE__ */ jsxs14("div", { className: "skc-page-header__trailing", children: [
                  ...
                  /* @__PURE__ */ jsx22(
                    ...
                    __spreadValues({
                      appearance: "text",
                      icon: brand || /* @__PURE__ */ jsx22(MaterialIcon, { icon: "home" }),
                      href: homeURL,
                      element
                    }, backAttr)
                  ),
