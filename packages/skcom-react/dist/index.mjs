...
function TableCell({
  ...
  const content = /* @__PURE__ */ jsx45("div", { className: "skc-table-cell__content", children });
...
function TextField({
  ...
  const [minifyLabel, setMinifyLabel] = React24.useState();
  const [neverResetLabel, setNeverMinifyLabel] = React24.useState(false);
  ...
  React24.useEffect(() => expandTextarea, [value]);
  const [error, setError] = React24.useState(false);
  React24.useEffect(() => setError(Boolean(incError)), [incError]);
  ...
  return /* @__PURE__ */ jsxs27(
    "label",
    {
      ...
      children: [
        ...
        leading && /* @__PURE__ */ jsx46(motion19.div, { className: "skc-text-field__leading", children: leading }),
        ...
        /* @__PURE__ */ jsx46(LayoutGroup3, { children: /* @__PURE__ */ jsxs27(AnimatePresence9, { initial: false, children: [
...
import { Fragment as Fragment13, jsx as jsx47 } from "react/jsx-runtime";
function ThemeProvider({ children }) {
  return /* @__PURE__ */ jsx47(Fragment13, { children });
}
