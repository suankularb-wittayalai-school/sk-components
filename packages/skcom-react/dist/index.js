...
function NavBar({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime14.jsxs)("nav", { style, className: cn(["skc-nav-bar", className]), children: [
    /* @__PURE__ */ (0, import_jsx_runtime14.jsxs)("div", { className: "skc-nav-bar__main", children: [
      /* @__PURE__ */ (0, import_jsx_runtime14.jsxs)("section", { className: "skc-nav-bar__toggle-and-fab", children: [
        /* @__PURE__ */ (0, import_jsx_runtime14.jsx)(
          Button,
          {
            appearance: "text",
            icon: /* @__PURE__ */ (0, import_jsx_runtime14.jsx)(MaterialIcon, { icon: "menu" }),
            alt: locale === "th" ? "\u0E40\u0E1B\u0E34\u0E14\u0E40\u0E21\u0E19\u0E39" : "Toggle Navigation Drawer",
            onClick: onNavToggle
          }
        ),
        /* @__PURE__ */ (0, import_jsx_runtime14.jsx)("div", { className: "skc-nav-bar__brand", children: brand }),
        fab
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime14.jsx)("section", { className: "skc-nav-bar__destinations", children })
    ] }),
    /* @__PURE__ */ (0, import_jsx_runtime14.jsx)("section", { className: "skc-nav-bar__end", children: end })
  ] });
}
...
function NavBarItem({
  ...
  const content = /* @__PURE__ */ (0, import_jsx_runtime15.jsxs)(import_jsx_runtime15.Fragment, { children: [
    /* @__PURE__ */ (0, import_jsx_runtime15.jsxs)("div", { ref: iconRef, className: "skc-nav-bar-item__icon", children: [
      icon,
      /* @__PURE__ */ (0, import_jsx_runtime15.jsx)(import_framer_motion6.LayoutGroup, { children: /* @__PURE__ */ (0, import_jsx_runtime15.jsx)(import_framer_motion6.AnimatePresence, { children: badge !== void 0 && /* @__PURE__ */ (0, import_jsx_runtime15.jsx)(
    ...
    label && /* @__PURE__ */ (0, import_jsx_runtime15.jsx)("span", { id: navID, className: "skc-nav-bar-item__label", children: label })
  ] });
  return (
    // Render with `element` if defined
    Element ? /* @__PURE__ */ (0, import_jsx_runtime15.jsx)(Element, __spreadProps(__spreadValues({}, props), { children: content })) : (
      // Otherwise, render an `<a>`
      /* @__PURE__ */ (0, import_jsx_runtime15.jsx)("a", __spreadProps(__spreadValues({}, props), { children: content }))
    )
  );
}
...
function NavDrawer({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime16.jsx)(import_framer_motion7.AnimatePresence, { children: open && /* @__PURE__ */ (0, import_jsx_runtime16.jsxs)(import_jsx_runtime16.Fragment, { children: [
    /* @__PURE__ */ (0, import_jsx_runtime16.jsx)(
      import_framer_motion7.motion.aside,
      {
        ...
        children: /* @__PURE__ */ (0, import_jsx_runtime16.jsx)("nav", { children: injectedChildren })
      }
    ),
    /* @__PURE__ */ (0, import_jsx_runtime16.jsx)(
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime17.jsxs)(
    "section",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ (0, import_jsx_runtime17.jsx)("ul", { children })
      ]
    }
  );
}
...
function NavDrawerItem({
  ...
  const content = /* @__PURE__ */ (0, import_jsx_runtime18.jsxs)(import_jsx_runtime18.Fragment, { children: [
    /* @__PURE__ */ (0, import_jsx_runtime18.jsx)("div", { className: "skc-nav-drawer-item__icon", children: icon }),
    /* @__PURE__ */ (0, import_jsx_runtime18.jsx)("span", { className: "skc-nav-drawer-item__label", children: label }),
    metadata && /* @__PURE__ */ (0, import_jsx_runtime18.jsx)("span", { className: "skc-nav-drawer-item__metadata", children: metadata }),
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime18.jsx)("li", { children: Element ? /* @__PURE__ */ (0, import_jsx_runtime18.jsx)(Element, __spreadProps(__spreadValues({}, props), { children: content })) : /* @__PURE__ */ (0, import_jsx_runtime18.jsx)("a", __spreadProps(__spreadValues({}, props), { children: content })) });
}
...
function FAB({
  ...
  const content = /* @__PURE__ */ (0, import_jsx_runtime19.jsx)(import_framer_motion9.AnimatePresence, {
    initial: false,
    // Hide the FAB on scroll if `stateOnScroll` set to `disappear`
    children: !(stateOnScroll === "disappear" && canHide && scrollDir === "down") && /* @__PURE__ */ (0, import_jsx_runtime19.jsxs)(
      import_framer_motion9.motion.div,
      {
        ...
        children: [
          icon && /* @__PURE__ */ (0, import_jsx_runtime19.jsx)("div", { className: "skc-fab__icon", children: icon }),
          // Hide the label on scroll if `stateOnScroll` set to `minimize`
          !(stateOnScroll === "minimize" && !(scrollDir === "up")) && children && /* @__PURE__ */ (0, import_jsx_runtime19.jsx)("span", { className: "skc-fab__label", children }),
  ...
  return (
    // Render with `element` if defined
    href && Element ? /* @__PURE__ */ (0, import_jsx_runtime19.jsx)(Element, __spreadProps(__spreadValues({}, props), { href, children: content })) : (
      // Render an `<a>` if link passed in
      href ? /* @__PURE__ */ (0, import_jsx_runtime19.jsx)("a", __spreadProps(__spreadValues({ href }, props), { children: content })) : (
        // Otherwise, render a `<button>`
        /* @__PURE__ */ (0, import_jsx_runtime19.jsx)("button", __spreadProps(__spreadValues({ type: "button", onClick }, props), { children: content }))
      )
    )
  );
}
...
function ContentLayout({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime20.jsx)(
    import_framer_motion10.motion.main,
    {
      ...
      children: /* @__PURE__ */ (0, import_jsx_runtime20.jsx)("div", { className: "skc-content-layout__content", children })
    }
  );
}
...
function RootLayout({ children, className, style }) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime21.jsxs)("div", { style, className: cn(["skc-root-layout", className]), children: [
...
function PageHeader({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime22.jsxs)(import_jsx_runtime22.Fragment, { children: [
    /* @__PURE__ */ (0, import_jsx_runtime22.jsx)("div", { className: "skc-page-header__replacement-color" }),
    ...
    /* @__PURE__ */ (0, import_jsx_runtime22.jsx)(import_framer_motion12.LayoutGroup, { children: /* @__PURE__ */ (0, import_jsx_runtime22.jsx)(
      import_framer_motion12.motion.header,
      {
        ...
        children: /* @__PURE__ */ (0, import_jsx_runtime22.jsxs)("div", { className: "skc-page-header__content", children: [
          icon && !children && /* @__PURE__ */ (0, import_jsx_runtime22.jsx)(
            ...
            import_framer_motion12.motion.div,
            {
              ...
              children: [
                /* @__PURE__ */ (0, import_jsx_runtime22.jsx)(
                  ...
                  {
                    appearance: "text",
                    icon: /* @__PURE__ */ (0, import_jsx_runtime22.jsx)(MaterialIcon, { icon: "arrow_backward" }),
                    onClick: onBack,
                    href: parentURL,
                    element,
                ...
                /* @__PURE__ */ (0, import_jsx_runtime22.jsx)(import_framer_motion12.motion.h1, __spreadProps(__spreadValues({}, headerTextProps), { children: title })),
                /* @__PURE__ */ (0, import_jsx_runtime22.jsxs)("div", { className: "skc-page-header__trailing", children: [
                  homeURL && // Home Button
                  /* @__PURE__ */ (0, import_jsx_runtime22.jsx)(
                    Button,
                    __spreadValues({
                      appearance: "text",
                      icon: brand || /* @__PURE__ */ (0, import_jsx_runtime22.jsx)(MaterialIcon, { icon: "home" }),
                      href: homeURL,
                      element
                    }, backAttr)
                  ),
