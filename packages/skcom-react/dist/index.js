...
function Tab({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime47.jsx)("li", {
    "aria-labelledby": tabID,
    // Render with `element` if defined
    children: href && Element ? /* @__PURE__ */ (0, import_jsx_runtime47.jsx)(Element, __spreadProps(__spreadValues({}, props), { href, children: content })) : (
      // Render an `<a>` if link passed in
