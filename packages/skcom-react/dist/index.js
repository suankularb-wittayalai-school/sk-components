...
function Menu({
  ...
  const { duration, easing } = useAnimationConfig();
  return /* @__PURE__ */ (0, import_jsx_runtime23.jsx)(import_framer_motion12.AnimatePresence, { children: open && /* @__PURE__ */ (0, import_jsx_runtime23.jsxs)(import_jsx_runtime23.Fragment, { children: [
    /* @__PURE__ */ (0, import_jsx_runtime23.jsx)(
      import_framer_motion12.motion.ul,
      __spreadProps(__spreadValues({
        role: "menu",
    ...
    onBlur && /* @__PURE__ */ (0, import_jsx_runtime23.jsx)("div", { className: "skc-menu__blur-capture", onClick: onBlur })
  ] }) });
}
...
function TableCell({
  ...
  const content = menu ? /* @__PURE__ */ (0, import_jsx_runtime24.jsxs)(import_jsx_runtime24.Fragment, { children: [
    /* @__PURE__ */ (0, import_jsx_runtime24.jsxs)(
      ...
      __spreadProps(__spreadValues({
        ...
        children: [
          /* @__PURE__ */ (0, import_jsx_runtime24.jsx)("div", { className: "skc-table-cell__content", children }),
          /* @__PURE__ */ (0, import_jsx_runtime24.jsx)(MaterialIcon, { icon: "arrow_drop_down" }),
    ...
    React12.cloneElement(
      /* @__PURE__ */ (0, import_jsx_runtime24.jsx)(Menu, { children: React12.Children.map(
        menu.props.children,
        (menuItem) => React12.cloneElement(menuItem, {
          onClick: () => {
  ...
  return header ? /* @__PURE__ */ (0, import_jsx_runtime24.jsx)("th", __spreadProps(__spreadValues({}, props), { children: content })) : /* @__PURE__ */ (0, import_jsx_runtime24.jsx)("td", __spreadProps(__spreadValues({}, props), { children: content }));
}
...
function DataTableHead({
  ...
  const { duration, easing } = useAnimationConfig();
  return /* @__PURE__ */ (0, import_jsx_runtime26.jsx)(TableHead, __spreadProps(__spreadValues({}, { style, className }), { children: headerGroups.map((headerGroup) => /* @__PURE__ */ (0, import_jsx_runtime26.jsx)(TableRow, { children: headerGroup.headers.map((header) => {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime26.jsx)(
      ...
      __spreadProps(__spreadValues({
        ...
        children: /* @__PURE__ */ (0, import_jsx_runtime26.jsxs)(import_framer_motion14.LayoutGroup, { children: [
          /* @__PURE__ */ (0, import_jsx_runtime26.jsx)(import_framer_motion14.AnimatePresence, { children: header.column.getIsSorted() && /* @__PURE__ */ (0, import_jsx_runtime26.jsx)(
            import_framer_motion14.motion.div,
            {
              ...
              children: /* @__PURE__ */ (0, import_jsx_runtime26.jsx)(MaterialIcon, { icon: "arrow_upward" })
            }
          ) }),
...
function TableBody({ children, style, className }) {
  return /* @__PURE__ */ (0, import_jsx_runtime27.jsx)("tbody", { style, className: cn(["skc-table-body", className]), children });
}
...
function FullscreenDialog({
  ...
  const injectedChildren = React15.Children.map(children, (child) => {
    if (child.type === "p") {
      if (pIsInjected)
        return child;
      pIsInjected = true;
...
function FormItem({
  ...
  const injectedChildren = React16.cloneElement(
...
function NavBar({
  ...
  const { atBreakpoint } = useBreakpoint();
  const navRailFab = React18.Children.map(fab, (child) => {
    var _a;
...
function NavBarItem({
  ...
  const { duration, easing } = useAnimationConfig();
  const iconRef = React19.useRef(null);
  const [clientHeight, setClientHeight] = React19.useState(1080);
  React19.useEffect(() => {
...
function NavDrawer({
  ...
  const injectedChildren = (
    ...
    React20.Children.map(
      children,
      (section) => React20.cloneElement(section, {
        children: (
          ...
          React20.Children.map(
            ...
            (item) => React20.cloneElement(item, { onClick: onClose })
          )
        )
      })
    )
...
function NavDrawerItem({
  ...
  const linkRef = React21.useRef(null);
...
function FAB({
  ...
  const { duration, easing } = useAnimationConfig();
  const fabRef = React22.useRef(null);
  const { rippleListeners, rippleControls, rippleStyle } = useRipple(fabRef);
  const { scrollDir } = useScrollDirection();
  const [canHide, setCanHide] = React22.useState(false);
  React22.useEffect(() => {
    if (stateOnScroll) {
...
function RootLayout({
  ...
  let content;
  const persistentComponents = React23.Children.map(children, (child) => {
...
function PageHeader({
  ...
  var _a;
  const headerRef = React25.useRef(null);
  const [minimized, setMinimized] = React25.useState(false);
  React25.useEffect(() => {
...
function Select({
  ...
  var _a, _b;
  const { duration, easing } = useAnimationConfig();
  const [menuOpen, setMenuOpen] = React28.useState();
  ...
  const toggleRef = React28.createRef();
  React28.useEffect(() => {
    var _a2;
    if (menuOpen === false)
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime53.jsxs)("div", { className: "skc-select__anchor", children: [
    ...
    /* @__PURE__ */ (0, import_jsx_runtime53.jsx)(
      ...
      __spreadProps(__spreadValues({
        ...
        children: React28.Children.map(
          children,
          (child) => React28.cloneElement(child, {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime54.jsx)("aside", { children: /* @__PURE__ */ (0, import_jsx_runtime54.jsx)(import_framer_motion28.AnimatePresence, __spreadProps(__spreadValues({}, { onExitComplete }), { children: open && /* @__PURE__ */ (0, import_jsx_runtime54.jsxs)(
    import_framer_motion28.motion.div,
    {
      ...
      children: [
        ...
        action && /* @__PURE__ */ (0, import_jsx_runtime54.jsx)("div", { className: "skc-snackbar__action", children: React29.cloneElement(action, {
          onClick: () => {
            if (onClose)
              onClose();
