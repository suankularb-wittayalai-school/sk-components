...
function AssistChip({
  ...
  const content = /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)(import_jsx_runtime8.Fragment, { children: [
    icon && /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("div", { className: "skc-assist-chip__icon", children: icon }),
    /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("span", { className: "skc-assist-chip__label", children }),
  ...
  return (
    ...
    href && Element ? /* @__PURE__ */ (0, import_jsx_runtime8.jsx)(Element, __spreadProps(__spreadValues({}, props), { href, children: content })) : (
      // Render an `<a>` if link passed in
      href ? /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("a", __spreadProps(__spreadValues({}, props), { href, children: content })) : (
        // Otherwise, render a `<button>`
        /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("button", __spreadProps(__spreadValues({}, props), { type: "button", children: content }))
      )
    )
  );
}
...
function Divider({ style, className }) {
  return /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("hr", { style, className: cn(["skc-divider", className]) });
}
...
function Header({
  ...
  const content = /* @__PURE__ */ (0, import_jsx_runtime10.jsxs)(import_jsx_runtime10.Fragment, { children: [
    icon && /* @__PURE__ */ (0, import_jsx_runtime10.jsx)("span", { className: "skc-header__icon", children: icon }),
    /* @__PURE__ */ (0, import_jsx_runtime10.jsx)("span", { className: "skc-header__text", children })
  ] });
  return level === 6 ? /* @__PURE__ */ (0, import_jsx_runtime10.jsx)("h6", __spreadProps(__spreadValues({}, props), { children: content })) : level === 5 ? /* @__PURE__ */ (0, import_jsx_runtime10.jsx)("h5", __spreadProps(__spreadValues({}, props), { children: content })) : level === 4 ? /* @__PURE__ */ (0, import_jsx_runtime10.jsx)("h4", __spreadProps(__spreadValues({}, props), { children: content })) : level === 3 ? /* @__PURE__ */ (0, import_jsx_runtime10.jsx)("h3", __spreadProps(__spreadValues({}, props), { children: content })) : /* @__PURE__ */ (0, import_jsx_runtime10.jsx)("h2", __spreadProps(__spreadValues({}, props), { children: content }));
}
...
function NavBar({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime11.jsxs)("nav", { style, className: cn(["skc-nav-bar", className]), children: [
    /* @__PURE__ */ (0, import_jsx_runtime11.jsxs)("div", { className: "skc-nav-bar__main", children: [
      /* @__PURE__ */ (0, import_jsx_runtime11.jsxs)("section", { className: "skc-nav-bar__toggle-and-fab", children: [
        /* @__PURE__ */ (0, import_jsx_runtime11.jsx)(
          Button,
          {
            appearance: "text",
            icon: /* @__PURE__ */ (0, import_jsx_runtime11.jsx)(MaterialIcon, { icon: "menu" }),
            alt: locale === "th" ? "\u0E40\u0E1B\u0E34\u0E14\u0E40\u0E21\u0E19\u0E39" : "Toggle Navigation Drawer",
            onClick: onNavToggle
          }
        ),
        /* @__PURE__ */ (0, import_jsx_runtime11.jsx)("div", { className: "skc-nav-bar__brand", children: brand }),
        fab
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime11.jsx)("section", { className: "skc-nav-bar__destinations", children })
    ] }),
    /* @__PURE__ */ (0, import_jsx_runtime11.jsx)("section", { className: "skc-nav-bar__end", children: end })
  ] });
}
...
function NavBarItem({
  ...
  const { duration, easing } = useAnimationConfig();
  const iconRef = React6.useRef(null);
  const [clientHeight, setClientHeight] = React6.useState(1080);
  React6.useEffect(() => {
  ...
  const content = /* @__PURE__ */ (0, import_jsx_runtime12.jsxs)(import_jsx_runtime12.Fragment, { children: [
    /* @__PURE__ */ (0, import_jsx_runtime12.jsxs)("div", { ref: iconRef, className: "skc-nav-bar-item__icon", children: [
      icon,
      /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(import_framer_motion6.LayoutGroup, { children: /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(import_framer_motion6.AnimatePresence, { children: badge !== void 0 && /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(
    ...
    label && /* @__PURE__ */ (0, import_jsx_runtime12.jsx)("span", { id: navID, className: "skc-nav-bar-item__label", children: label })
  ] });
  return (
    // Render with `element` if defined
    Element ? /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(Element, __spreadProps(__spreadValues({}, props), { children: content })) : (
      // Otherwise, render an `<a>`
      /* @__PURE__ */ (0, import_jsx_runtime12.jsx)("a", __spreadProps(__spreadValues({}, props), { children: content }))
    )
  );
}
...
function NavDrawer({
  ...
  const injectedChildren = (
    ...
    React7.Children.map(
      children,
      (section) => React7.cloneElement(section, {
        children: (
          ...
          React7.Children.map(
            ...
            (item) => React7.cloneElement(item, { onClick: onClose })
          )
        )
      })
    )
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(import_framer_motion7.AnimatePresence, { children: open && /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)(import_jsx_runtime13.Fragment, { children: [
    /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(
      import_framer_motion7.motion.aside,
      {
        ...
        children: /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("nav", { children: injectedChildren })
      }
    ),
    /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime14.jsxs)(
    "section",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ (0, import_jsx_runtime14.jsx)("ul", { children })
      ]
    }
  );
}
...
function NavDrawerItem({
  ...
  const linkRef = React8.useRef(null);
  ...
  const content = /* @__PURE__ */ (0, import_jsx_runtime15.jsxs)(import_jsx_runtime15.Fragment, { children: [
    /* @__PURE__ */ (0, import_jsx_runtime15.jsx)("div", { className: "skc-nav-drawer-item__icon", children: icon }),
    /* @__PURE__ */ (0, import_jsx_runtime15.jsx)("span", { className: "skc-nav-drawer-item__label", children: label }),
    metadata && /* @__PURE__ */ (0, import_jsx_runtime15.jsx)("span", { className: "skc-nav-drawer-item__metadata", children: metadata }),
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime15.jsx)("li", { children: Element ? /* @__PURE__ */ (0, import_jsx_runtime15.jsx)(Element, __spreadProps(__spreadValues({}, props), { children: content })) : /* @__PURE__ */ (0, import_jsx_runtime15.jsx)("a", __spreadProps(__spreadValues({}, props), { children: content })) });
}
...
function FAB({
  ...
  const { duration, easing } = useAnimationConfig();
  const fabRef = React10.useRef(null);
  const { rippleListeners, rippleControls, rippleStyle } = useRipple(fabRef);
  const { scrollDir } = useScrollDirection();
  const [canHide, setCanHide] = React10.useState(false);
  React10.useEffect(() => {
    if (stateOnScroll) {
  ...
  const content = /* @__PURE__ */ (0, import_jsx_runtime16.jsx)(import_framer_motion9.AnimatePresence, {
    initial: false,
    // Hide the FAB on scroll if `stateOnScroll` set to `disappear`
    children: !(stateOnScroll === "disappear" && canHide && scrollDir === "down") && /* @__PURE__ */ (0, import_jsx_runtime16.jsxs)(
      import_framer_motion9.motion.div,
      {
        ...
        children: [
          icon && /* @__PURE__ */ (0, import_jsx_runtime16.jsx)("div", { className: "skc-fab__icon", children: icon }),
          // Hide the label on scroll if `stateOnScroll` set to `minimize`
          !(stateOnScroll === "minimize" && !(scrollDir === "up")) && children && /* @__PURE__ */ (0, import_jsx_runtime16.jsx)("span", { className: "skc-fab__label", children }),
  ...
  return (
    // Render with `element` if defined
    href && Element ? /* @__PURE__ */ (0, import_jsx_runtime16.jsx)(Element, __spreadProps(__spreadValues({}, props), { href, children: content })) : (
      // Render an `<a>` if link passed in
      href ? /* @__PURE__ */ (0, import_jsx_runtime16.jsx)("a", __spreadProps(__spreadValues({ href }, props), { children: content })) : (
        // Otherwise, render a `<button>`
        /* @__PURE__ */ (0, import_jsx_runtime16.jsx)("button", __spreadProps(__spreadValues({ type: "button", onClick }, props), { children: content }))
      )
    )
  );
}
...
function ContentLayout({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime17.jsx)(
    import_framer_motion10.motion.main,
    {
      ...
      children: /* @__PURE__ */ (0, import_jsx_runtime17.jsx)("div", { className: "skc-content-layout__content", children })
    }
  );
}
...
function RootLayout({ children, className, style }) {
  let content;
  const persistentComponents = React11.Children.map(children, (child) => {
    if (child.type.displayName)
      return child;
    else
      content = child;
  });
  return /* @__PURE__ */ (0, import_jsx_runtime18.jsxs)("div", { style, className: cn(["skc-root-layout", className]), children: [
...
function PageHeader({
  ...
  const [minimized, setMinimized] = React12.useState(false);
  React12.useEffect(() => {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime19.jsxs)(import_jsx_runtime19.Fragment, { children: [
    /* @__PURE__ */ (0, import_jsx_runtime19.jsx)("div", { className: "skc-page-header__replacement-color" }),
    ...
    /* @__PURE__ */ (0, import_jsx_runtime19.jsx)(import_framer_motion12.LayoutGroup, { children: /* @__PURE__ */ (0, import_jsx_runtime19.jsx)(
      import_framer_motion12.motion.header,
      {
        ...
        children: /* @__PURE__ */ (0, import_jsx_runtime19.jsxs)("div", { className: "skc-page-header__content", children: [
          icon && !children && /* @__PURE__ */ (0, import_jsx_runtime19.jsx)(
            ...
            import_framer_motion12.motion.div,
            {
              ...
              children: [
                /* @__PURE__ */ (0, import_jsx_runtime19.jsx)(
                  ...
                  {
                    appearance: "text",
                    icon: /* @__PURE__ */ (0, import_jsx_runtime19.jsx)(MaterialIcon, { icon: "arrow_backward" }),
                    onClick: onBack,
                    href: parentURL,
                    element,
                ...
                /* @__PURE__ */ (0, import_jsx_runtime19.jsx)(import_framer_motion12.motion.h1, __spreadProps(__spreadValues({}, headerTextProps), { children: title })),
                /* @__PURE__ */ (0, import_jsx_runtime19.jsxs)("div", { className: "skc-page-header__trailing", children: [
                  homeURL && // Home Button
                  /* @__PURE__ */ (0, import_jsx_runtime19.jsx)(
                    Button,
                    __spreadValues({
                      appearance: "text",
                      icon: brand || /* @__PURE__ */ (0, import_jsx_runtime19.jsx)(MaterialIcon, { icon: "home" }),
                      href: homeURL,
                      element
                    }, backAttr)
                  ),
