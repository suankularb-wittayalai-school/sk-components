  ...
  return /* @__PURE__ */ (0, import_jsx_runtime24.jsx)(TableHead, __spreadProps(__spreadValues({}, { style, className }), { children: headerGroups.map((headerGroup) => /* @__PURE__ */ (0, import_jsx_runtime24.jsx)(TableRow, { children: headerGroup.headers.map((header) => {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime24.jsxs)(
      ...
      __spreadProps(__spreadValues(__spreadValues({
        ...
        tabIndex: 0
      }, rippleListeners), header.column.columnDef.thAttr), {
        children: [
...
function DataTablePagination({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime29.jsxs)("div", { style, className: cn(["skc-data-table-pagination", className]), children: [
    /* @__PURE__ */ (0, import_jsx_runtime29.jsx)("span", { className: "skc-data-table-pagination__label", children: `${page}-${page + rowsPerPage - 1} ${locale === "th" ? "\u0E08\u0E32\u0E01" : "of"} ${totalRows}` }),
