...
function FAB({
  ...
  const content = /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_framer_motion6.AnimatePresence, {
    children: !(stateOnScroll === "disappear" && !(scrollDir === "up")) && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_framer_motion6.motion.div, {
      ref: fabRef,
      style,
      className: cn([
        "skc-fab",
