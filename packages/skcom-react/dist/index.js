...
function InputChip({
  ...
  const divContent = /* @__PURE__ */ (0, import_jsx_runtime12.jsxs)(import_jsx_runtime12.Fragment, { children: [
    avatar && /* @__PURE__ */ (0, import_jsx_runtime12.jsx)("div", { className: "skc-input-chip__avatar", children: selected ? /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(MaterialIcon, { icon: "done" }) : avatar }),
    icon && /* @__PURE__ */ (0, import_jsx_runtime12.jsx)("div", { className: "skc-input-chip__icon", children: icon }),
    /* @__PURE__ */ (0, import_jsx_runtime12.jsx)("span", { className: "skc-input-chip__label", children }),
    onDelete && /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(
      Button,
      {
        appearance: "text",
        icon: /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(MaterialIcon, { icon: "close" }),
        onClick: onDelete
      }
    )
  ] });
  ...
  return editing ? /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(
    "input",
    {
      ref: inputRef,
  ...
  ) : editable || onClick ? layoutID ? /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(import_framer_motion6.motion.button, __spreadProps(__spreadValues({ layoutId: layoutID }, buttonProps), { children: buttonContent })) : /* @__PURE__ */ (0, import_jsx_runtime12.jsx)("button", __spreadProps(__spreadValues({}, buttonProps), { children: buttonContent })) : layoutID ? /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(import_framer_motion6.motion.div, __spreadProps(__spreadValues({ layoutId: layoutID }, divProps), { children: divContent })) : /* @__PURE__ */ (0, import_jsx_runtime12.jsx)("div", __spreadProps(__spreadValues({}, divProps), { children: divContent }));
}
...
function AssistChip({
  ...
  const content = /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)(import_jsx_runtime13.Fragment, { children: [
    icon && /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("div", { className: "skc-assist-chip__icon", children: icon }),
    /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("span", { className: "skc-assist-chip__label", children }),
  ...
  return (
    // Render with `element` if defined
    href && Element ? /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(Element, __spreadProps(__spreadValues({}, props), { href, children: content })) : (
      // Render an `<a>` if link passed in
      href ? /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("a", __spreadProps(__spreadValues({}, props), { href, children: content })) : (
        // Otherwise, render a `<button>`
        /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("button", __spreadProps(__spreadValues({}, props), { type: "button", children: content }))
      )
    )
  );
}
...
function ChipSet({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime14.jsx)(
    "div",
    {
      ...
      children: scrollable ? /* @__PURE__ */ (0, import_jsx_runtime14.jsx)("div", { className: "skc-chip-set", children }) : children
    }
  );
}
...
function ChipField({
  ...
  const [lastSelected, setLastSelected] = React8.useState(false);
  const [noOfChips, setNoOfChips] = React8.useState(0);
  React8.useEffect(
    () => setNoOfChips(
      React8.Children.count(
        React8.Children.only(children).props.children
      )
    ),
    [children]
  );
  const { duration, easing } = useAnimationConfig();
  const labelControls = (0, import_framer_motion8.useAnimationControls)();
  const [minifyLabel, setMinifyLabel] = React8.useState();
  const [neverResetLabel, setNeverResetLabel] = React8.useState(false);
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime15.jsxs)("div", { style, className: cn(["skc-chip-field", className]), children: [
    ...
    /* @__PURE__ */ (0, import_jsx_runtime15.jsx)("div", { className: "skc-chip-field__scrollable", children: /* @__PURE__ */ (0, import_jsx_runtime15.jsxs)("div", { className: "skc-chip-field__content", children: [
      lastSelected ? (
        ...
        // selected
        /* @__PURE__ */ (0, import_jsx_runtime15.jsx)(ChipSet, { children: React8.Children.map(
          React8.Children.only(children).props.children,
          (child, idx) => {
            if (idx === noOfChips - 1)
...
function Dialog({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime16.jsx)(import_framer_motion9.AnimatePresence, { children: open && /* @__PURE__ */ (0, import_jsx_runtime16.jsxs)(import_jsx_runtime16.Fragment, { children: [
...
function DialogHeader({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime17.jsxs)("div", { style, className: cn(["skc-dialog-header", className]), children: [
    icon && /* @__PURE__ */ (0, import_jsx_runtime17.jsx)("div", { className: "skc-dialog-header__icon", children: icon }),
    title && /* @__PURE__ */ (0, import_jsx_runtime17.jsx)("h2", { "aria-label": alt, id: `${dialogID}-title`, children: title }),
...
function FullscreenDialog({
  ...
  const injectedChildren = React11.Children.map(children, (child) => {
    if (child.type === "p") {
      if (pIsInjected)
        return child;
      pIsInjected = true;
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime19.jsx)(import_framer_motion10.AnimatePresence, { children: open && /* @__PURE__ */ (0, import_jsx_runtime19.jsxs)(import_jsx_runtime19.Fragment, { children: [
    /* @__PURE__ */ (0, import_jsx_runtime19.jsxs)(
      import_framer_motion10.motion.div,
      {
        ...
        children: [
          /* @__PURE__ */ (0, import_jsx_runtime19.jsxs)("div", { className: "skc-fullscreen-dialog__top-app-bar", children: [
            /* @__PURE__ */ (0, import_jsx_runtime19.jsx)(
              Button,
              {
                appearance: "text",
                icon: /* @__PURE__ */ (0, import_jsx_runtime19.jsx)(MaterialIcon, { icon: "close" }),
                alt: locale === "th" ? "\u0E1B\u0E34\u0E14\u0E2B\u0E19\u0E49\u0E32\u0E15\u0E48\u0E32\u0E07" : "Close",
                onClick: onClose
              }
            ),
            /* @__PURE__ */ (0, import_jsx_runtime19.jsx)("h2", { id: `${dialogID}-title`, children: title }),
            action
          ] }),
          /* @__PURE__ */ (0, import_jsx_runtime19.jsx)(import_framer_motion10.motion.div, { className: "skc-fullscreen-dialog__content", children: injectedChildren })
        ]
      }
    ),
    /* @__PURE__ */ (0, import_jsx_runtime19.jsx)(
...
function Divider({ style, className }) {
  return /* @__PURE__ */ (0, import_jsx_runtime20.jsx)("hr", { style, className: cn(["skc-divider", className]) });
}
...
function Header({
  ...
  const content = /* @__PURE__ */ (0, import_jsx_runtime21.jsxs)(import_jsx_runtime21.Fragment, { children: [
    icon && /* @__PURE__ */ (0, import_jsx_runtime21.jsx)("span", { className: "skc-header__icon", children: icon }),
    /* @__PURE__ */ (0, import_jsx_runtime21.jsx)("span", { className: "skc-header__text", children })
  ] });
  return level === 6 ? /* @__PURE__ */ (0, import_jsx_runtime21.jsx)("h6", __spreadProps(__spreadValues({}, props), { children: content })) : level === 5 ? /* @__PURE__ */ (0, import_jsx_runtime21.jsx)("h5", __spreadProps(__spreadValues({}, props), { children: content })) : level === 4 ? /* @__PURE__ */ (0, import_jsx_runtime21.jsx)("h4", __spreadProps(__spreadValues({}, props), { children: content })) : level === 3 ? /* @__PURE__ */ (0, import_jsx_runtime21.jsx)("h3", __spreadProps(__spreadValues({}, props), { children: content })) : /* @__PURE__ */ (0, import_jsx_runtime21.jsx)("h2", __spreadProps(__spreadValues({}, props), { children: content }));
}
...
function List({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime22.jsx)(
    "ul",
    {
      ...
      children: columns ? /* @__PURE__ */ (0, import_jsx_runtime22.jsx)(Columns, { columns, children }) : children
    }
  );
}
...
function ListItem({
  ...
  const content = /* @__PURE__ */ (0, import_jsx_runtime23.jsxs)(import_jsx_runtime23.Fragment, { children: [
    children,
    stateLayerEffect && /* @__PURE__ */ (0, import_jsx_runtime23.jsx)(
  ...
  return (
    ...
    href || onClick || stateLayerEffect ? /* @__PURE__ */ (0, import_jsx_runtime23.jsx)("li", {
      "aria-labelledby": itemID,
      // Render with `element` if defined
      children: href && Element ? /* @__PURE__ */ (0, import_jsx_runtime23.jsx)(Element, __spreadProps(__spreadValues({}, props), { href, children: content })) : (
        // Render an `<a>` if link passed in
        href ? /* @__PURE__ */ (0, import_jsx_runtime23.jsx)("a", __spreadProps(__spreadValues({}, props), { href, children: content })) : (
          // Otherwise, render a `<button>`
          /* @__PURE__ */ (0, import_jsx_runtime23.jsx)("button", __spreadProps(__spreadValues({}, __spreadProps(__spreadValues({}, props), { onClick })), { type: "button", children: content }))
        )
      )
    }) : (
      // If this Item has no functionality, just render a `<li>`
      /* @__PURE__ */ (0, import_jsx_runtime23.jsx)("li", __spreadProps(__spreadValues({}, props), { children: content }))
    )
  );
}
...
function ListItemContent({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime24.jsxs)("div", { style, className: cn(["skc-list-item-content", className]), children: [
    overline && /* @__PURE__ */ (0, import_jsx_runtime24.jsx)("span", { className: "skc-list-item-content__overline", children: overline }),
    ...
    desc && /* @__PURE__ */ (0, import_jsx_runtime24.jsx)("span", { className: "skc-list-item-content__desc", children: desc })
  ] });
}
...
function NavBar({
  ...
  const { atBreakpoint } = useBreakpoint();
  const navRailFab = React13.Children.map(fab, (child) => {
    var _a;
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime25.jsxs)("nav", { style, className: cn(["skc-nav-bar", className]), children: [
    /* @__PURE__ */ (0, import_jsx_runtime25.jsxs)("div", { className: "skc-nav-bar__main", children: [
      /* @__PURE__ */ (0, import_jsx_runtime25.jsxs)("section", { className: "skc-nav-bar__toggle-and-fab", children: [
        /* @__PURE__ */ (0, import_jsx_runtime25.jsx)(
          Button,
          {
            appearance: "text",
            icon: /* @__PURE__ */ (0, import_jsx_runtime25.jsx)(MaterialIcon, { icon: "menu" }),
            alt: locale === "th" ? "\u0E40\u0E1B\u0E34\u0E14\u0E40\u0E21\u0E19\u0E39" : "Toggle Navigation Drawer",
            onClick: onNavToggle
          }
        ),
        /* @__PURE__ */ (0, import_jsx_runtime25.jsx)("div", { className: "skc-nav-bar__brand", children: brand }),
        atBreakpoint === "base" ? fab : navRailFab
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime25.jsx)("section", { className: "skc-nav-bar__destinations", children })
    ] }),
    /* @__PURE__ */ (0, import_jsx_runtime25.jsx)("section", { className: "skc-nav-bar__end", children: end })
  ] });
}
...
function NavBarItem({
  ...
  const { duration, easing } = useAnimationConfig();
  const iconRef = React14.useRef(null);
  const [clientHeight, setClientHeight] = React14.useState(1080);
  React14.useEffect(() => {
  ...
  const content = /* @__PURE__ */ (0, import_jsx_runtime26.jsxs)(import_jsx_runtime26.Fragment, { children: [
    /* @__PURE__ */ (0, import_jsx_runtime26.jsxs)("div", { ref: iconRef, className: "skc-nav-bar-item__icon", children: [
      icon,
      /* @__PURE__ */ (0, import_jsx_runtime26.jsx)(import_framer_motion12.LayoutGroup, { children: /* @__PURE__ */ (0, import_jsx_runtime26.jsx)(import_framer_motion12.AnimatePresence, { children: badge !== void 0 && /* @__PURE__ */ (0, import_jsx_runtime26.jsx)(
    ...
    label && /* @__PURE__ */ (0, import_jsx_runtime26.jsx)("span", { id: navID, className: "skc-nav-bar-item__label", children: label })
  ] });
  return (
    // Render with `element` if defined
    Element ? /* @__PURE__ */ (0, import_jsx_runtime26.jsx)(Element, __spreadProps(__spreadValues({}, props), { children: content })) : (
      // Otherwise, render an `<a>`
      /* @__PURE__ */ (0, import_jsx_runtime26.jsx)("a", __spreadProps(__spreadValues({}, props), { children: content }))
    )
  );
}
...
function NavDrawer({
  ...
  const injectedChildren = (
    ...
    React15.Children.map(
      children,
      (section) => React15.cloneElement(section, {
        children: (
          ...
          React15.Children.map(
            ...
            (item) => React15.cloneElement(item, { onClick: onClose })
          )
        )
      })
    )
  );
  return /* @__PURE__ */ (0, import_jsx_runtime27.jsx)(import_framer_motion13.AnimatePresence, { children: open && /* @__PURE__ */ (0, import_jsx_runtime27.jsxs)(import_jsx_runtime27.Fragment, { children: [
    /* @__PURE__ */ (0, import_jsx_runtime27.jsx)(
      import_framer_motion13.motion.aside,
      {
        ...
        children: /* @__PURE__ */ (0, import_jsx_runtime27.jsx)("nav", { children: injectedChildren })
      }
    ),
    /* @__PURE__ */ (0, import_jsx_runtime27.jsx)(
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime28.jsxs)(
    "section",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ (0, import_jsx_runtime28.jsx)("ul", { role: "list", children })
      ]
    }
  );
}
...
function NavDrawerItem({
  ...
  const linkRef = React16.useRef(null);
  ...
  const content = /* @__PURE__ */ (0, import_jsx_runtime29.jsxs)(import_jsx_runtime29.Fragment, { children: [
    /* @__PURE__ */ (0, import_jsx_runtime29.jsx)("div", { className: "skc-nav-drawer-item__icon", children: icon }),
    /* @__PURE__ */ (0, import_jsx_runtime29.jsx)("span", { className: "skc-nav-drawer-item__label", children: label }),
    metadata && /* @__PURE__ */ (0, import_jsx_runtime29.jsx)("span", { className: "skc-nav-drawer-item__metadata", children: metadata }),
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime29.jsx)("li", { children: Element ? /* @__PURE__ */ (0, import_jsx_runtime29.jsx)(Element, __spreadProps(__spreadValues({}, props), { children: content })) : /* @__PURE__ */ (0, import_jsx_runtime29.jsx)("a", __spreadProps(__spreadValues({}, props), { children: content })) });
}
...
function FAB({
  ...
  const { duration, easing } = useAnimationConfig();
  const fabRef = React17.useRef(null);
  const { rippleListeners, rippleControls, rippleStyle } = useRipple(fabRef);
  const { scrollDir } = useScrollDirection();
  const [canHide, setCanHide] = React17.useState(false);
  React17.useEffect(() => {
    if (stateOnScroll) {
  ...
  const content = /* @__PURE__ */ (0, import_jsx_runtime30.jsx)(import_framer_motion15.AnimatePresence, {
    initial: false,
    // Hide the FAB on scroll if `stateOnScroll` set to `disappear`
    children: !(stateOnScroll === "disappear" && canHide && scrollDir === "down") && /* @__PURE__ */ (0, import_jsx_runtime30.jsxs)(
      import_framer_motion15.motion.div,
      {
        ...
        children: [
          icon && /* @__PURE__ */ (0, import_jsx_runtime30.jsx)("div", { className: "skc-fab__icon", children: icon }),
          // Hide the label on scroll if `stateOnScroll` set to `minimize`
          !(stateOnScroll === "minimize" && !(scrollDir === "up")) && children && /* @__PURE__ */ (0, import_jsx_runtime30.jsx)("span", { className: "skc-fab__label", children }),
  ...
  return (
    // Render with `element` if defined
    href && Element ? /* @__PURE__ */ (0, import_jsx_runtime30.jsx)(Element, __spreadProps(__spreadValues({}, props), { href, children: content })) : (
      // Render an `<a>` if link passed in
      href ? /* @__PURE__ */ (0, import_jsx_runtime30.jsx)("a", __spreadProps(__spreadValues({ href }, props), { children: content })) : (
        // Otherwise, render a `<button>`
        /* @__PURE__ */ (0, import_jsx_runtime30.jsx)("button", __spreadProps(__spreadValues({ type: "button", onClick }, props), { children: content }))
      )
    )
  );
}
...
function ContentLayout({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime31.jsx)(
    import_framer_motion16.motion.main,
    {
      initial: { opacity: 0 },
      animate: { opacity: 1 },
      exit: { opacity: 0 },
      ...
      children: /* @__PURE__ */ (0, import_jsx_runtime31.jsx)("div", { className: "skc-content-layout__content", children })
    }
  );
}
...
function RootLayout({ children, className, style }) {
  let content;
  const persistentComponents = React18.Children.map(children, (child) => {
    if (child == null ? void 0 : child.type.displayName)
      return child;
    else
      content = child;
  });
  return /* @__PURE__ */ (0, import_jsx_runtime32.jsxs)("div", { style, className: cn(["skc-root-layout", className]), children: [
...
function PageHeader({
  ...
  var _a;
  const headerRef = React19.useRef(null);
  const [minimized, setMinimized] = React19.useState(false);
  React19.useEffect(() => {
  ...
  const headerTextControls = (0, import_framer_motion18.useAnimationControls)();
  React19.useEffect(() => {
  ...
  const iconControls = (0, import_framer_motion18.useAnimationControls)();
  React19.useEffect(() => {
    if (icon || !minimized) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime33.jsxs)(import_jsx_runtime33.Fragment, { children: [
    /* @__PURE__ */ (0, import_jsx_runtime33.jsx)("div", { className: "skc-page-header__replacement-color" }),
    ...
    /* @__PURE__ */ (0, import_jsx_runtime33.jsx)(import_framer_motion18.LayoutGroup, { children: /* @__PURE__ */ (0, import_jsx_runtime33.jsx)(
      import_framer_motion18.motion.header,
      {
        ref: headerRef,
        ...
        children: /* @__PURE__ */ (0, import_jsx_runtime33.jsxs)("div", { className: "skc-page-header__content", children: [
          icon && !children && /* @__PURE__ */ (0, import_jsx_runtime33.jsx)(
            ...
            import_framer_motion18.motion.div,
            {
              ...
              children: [
                /* @__PURE__ */ (0, import_jsx_runtime33.jsx)(
                  ...
                  {
                    appearance: "text",
                    icon: /* @__PURE__ */ (0, import_jsx_runtime33.jsx)(MaterialIcon, { icon: "arrow_backward" }),
                ...
                /* @__PURE__ */ (0, import_jsx_runtime33.jsx)(import_framer_motion18.motion.h1, __spreadProps(__spreadValues({}, headerTextProps), { children: title })),
                /* @__PURE__ */ (0, import_jsx_runtime33.jsxs)("div", { className: "skc-page-header__trailing", children: [
                  homeURL && // Home Button
                  /* @__PURE__ */ (0, import_jsx_runtime33.jsx)(
                    Button,
                    __spreadValues({
                      appearance: "text",
                      icon: brand || /* @__PURE__ */ (0, import_jsx_runtime33.jsx)(MaterialIcon, { icon: "home" }),
                      href: homeURL,
                      element
                    }, backAttr)
                  ),
...
function Section({
  ...
  const modifiedChildren = (
    ...
    React20.Children.map(children, (child) => {
...
function Switch({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime35.jsx)(
    ...
    __spreadProps(__spreadValues({
      ...
      children: /* @__PURE__ */ (0, import_jsx_runtime35.jsx)("div", { className: "skc-switch__handle", children: value ? onIcon : offIcon })
    })
  );
}
...
function TextField({
  ...
  const { duration, easing } = useAnimationConfig();
  const labelControls = (0, import_framer_motion19.useAnimationControls)();
  const trailingControls = (0, import_framer_motion19.useAnimationControls)();
  const [minifyLabel, setMinifyLabel] = React21.useState();
  const [neverResetLabel, setNeverMinifyLabel] = React21.useState(false);
  ...
  React21.useEffect(() => expandTextarea, [value]);
  const [error, setError] = React21.useState(false);
  React21.useEffect(() => setError(Boolean(incError)), [incError]);
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime36.jsxs)(
    "label",
    {
      ...
      children: [
        ...
        leading && /* @__PURE__ */ (0, import_jsx_runtime36.jsx)(import_framer_motion19.motion.div, { className: "skc-text-field__leading", children: leading }),
        behavior === "single-line" ? /* @__PURE__ */ (0, import_jsx_runtime36.jsx)("input", __spreadValues(__spreadValues({}, inputProps), inputAttr)) : /* @__PURE__ */ (0, import_jsx_runtime36.jsx)("textarea", __spreadValues({ ref: textareaRef }, inputProps)),
        /* @__PURE__ */ (0, import_jsx_runtime36.jsx)(import_framer_motion19.LayoutGroup, { children: /* @__PURE__ */ (0, import_jsx_runtime36.jsxs)(import_framer_motion19.AnimatePresence, { initial: false, children: [
          trailing && /* @__PURE__ */ (0, import_jsx_runtime36.jsx)(
          ...
          (canClear || error) && /* @__PURE__ */ (0, import_jsx_runtime36.jsx)(
            import_framer_motion19.motion.div,
            {
              ...
              transition: fieldTransition,
              className: "skc-text-field__trailing",
              children: canClear ? /* @__PURE__ */ (0, import_jsx_runtime36.jsx)(
                Button,
                {
                  appearance: "text",
                  icon: /* @__PURE__ */ (0, import_jsx_runtime36.jsx)(MaterialIcon, { icon: "cancel" }),
                  disabled,
                  onClick: () => onChange && onChange("")
                }
              ) : error ? /* @__PURE__ */ (0, import_jsx_runtime36.jsx)(MaterialIcon, { icon: "error", fill: true }) : null
            }
          )
        ] }) }),
        helperMsg && /* @__PURE__ */ (0, import_jsx_runtime36.jsx)("span", { id: `${fieldID}-helper`, className: "skc-text-field__helper-msg", children: helperMsg })
      ]
    }
  );
}
