...
function Header({
  ...
  const content = /* @__PURE__ */ (0, import_jsx_runtime22.jsxs)(import_jsx_runtime22.Fragment, { children: [
    icon && /* @__PURE__ */ (0, import_jsx_runtime22.jsx)("span", { className: "skc-header__icon", children: icon }),
    /* @__PURE__ */ (0, import_jsx_runtime22.jsx)("span", { className: "skc-header__text", children })
  ] });
  return level === 6 ? /* @__PURE__ */ (0, import_jsx_runtime22.jsx)("h6", __spreadProps(__spreadValues({}, props), { children: content })) : level === 5 ? /* @__PURE__ */ (0, import_jsx_runtime22.jsx)("h5", __spreadProps(__spreadValues({}, props), { children: content })) : level === 4 ? /* @__PURE__ */ (0, import_jsx_runtime22.jsx)("h4", __spreadProps(__spreadValues({}, props), { children: content })) : level === 3 ? /* @__PURE__ */ (0, import_jsx_runtime22.jsx)("h3", __spreadProps(__spreadValues({}, props), { children: content })) : /* @__PURE__ */ (0, import_jsx_runtime22.jsx)("h2", __spreadProps(__spreadValues({}, props), { children: content }));
}
...
function List({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime23.jsx)(
    "ul",
    {
      ...
      children: columns ? /* @__PURE__ */ (0, import_jsx_runtime23.jsx)(Columns, { columns, children }) : children
    }
  );
}
...
function ListItem({
  ...
  const content = /* @__PURE__ */ (0, import_jsx_runtime24.jsxs)(import_jsx_runtime24.Fragment, { children: [
    children,
    stateLayerEffect && /* @__PURE__ */ (0, import_jsx_runtime24.jsx)(
  ...
  return (
    ...
    href || onClick || stateLayerEffect ? /* @__PURE__ */ (0, import_jsx_runtime24.jsx)("li", {
      "aria-labelledby": itemID,
      // Render with `element` if defined
      children: href && Element ? /* @__PURE__ */ (0, import_jsx_runtime24.jsx)(Element, __spreadProps(__spreadValues({}, props), { href, children: content })) : (
        // Render an `<a>` if link passed in
        href ? /* @__PURE__ */ (0, import_jsx_runtime24.jsx)("a", __spreadProps(__spreadValues({}, props), { href, children: content })) : (
          // Otherwise, render a `<button>`
          /* @__PURE__ */ (0, import_jsx_runtime24.jsx)("button", __spreadProps(__spreadValues({}, __spreadProps(__spreadValues({}, props), { onClick })), { type: "button", children: content }))
        )
      )
    }) : (
      // If this Item has no functionality, just render a `<li>`
      /* @__PURE__ */ (0, import_jsx_runtime24.jsx)("li", __spreadProps(__spreadValues({}, props), { children: content }))
    )
  );
}
...
function ListItemContent({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime25.jsxs)("div", { style, className: cn(["skc-list-item-content", className]), children: [
    overline && /* @__PURE__ */ (0, import_jsx_runtime25.jsx)("span", { className: "skc-list-item-content__overline", children: overline }),
    ...
    desc && /* @__PURE__ */ (0, import_jsx_runtime25.jsx)("span", { className: "skc-list-item-content__desc", children: desc })
  ] });
}
...
function NavBar({
  ...
  const { atBreakpoint } = useBreakpoint();
  const navRailFab = React14.Children.map(fab, (child) => {
    var _a;
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime26.jsxs)("nav", { style, className: cn(["skc-nav-bar", className]), children: [
    /* @__PURE__ */ (0, import_jsx_runtime26.jsxs)("div", { className: "skc-nav-bar__main", children: [
      /* @__PURE__ */ (0, import_jsx_runtime26.jsxs)("section", { className: "skc-nav-bar__toggle-and-fab", children: [
        /* @__PURE__ */ (0, import_jsx_runtime26.jsx)(
          Button,
          {
            appearance: "text",
            icon: /* @__PURE__ */ (0, import_jsx_runtime26.jsx)(MaterialIcon, { icon: "menu" }),
            alt: locale === "th" ? "\u0E40\u0E1B\u0E34\u0E14\u0E40\u0E21\u0E19\u0E39" : "Toggle Navigation Drawer",
            onClick: onNavToggle
          }
        ),
        /* @__PURE__ */ (0, import_jsx_runtime26.jsx)("div", { className: "skc-nav-bar__brand", children: brand }),
        atBreakpoint === "base" ? fab : navRailFab
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime26.jsx)("section", { className: "skc-nav-bar__destinations", children })
    ] }),
    /* @__PURE__ */ (0, import_jsx_runtime26.jsx)("section", { className: "skc-nav-bar__end", children: end })
  ] });
}
...
function NavBarItem({
  ...
  const { duration, easing } = useAnimationConfig();
  const iconRef = React15.useRef(null);
  const [clientHeight, setClientHeight] = React15.useState(1080);
  React15.useEffect(() => {
  ...
  const content = /* @__PURE__ */ (0, import_jsx_runtime27.jsxs)(import_jsx_runtime27.Fragment, { children: [
    /* @__PURE__ */ (0, import_jsx_runtime27.jsxs)("div", { ref: iconRef, className: "skc-nav-bar-item__icon", children: [
      icon,
      /* @__PURE__ */ (0, import_jsx_runtime27.jsx)(import_framer_motion13.LayoutGroup, { children: /* @__PURE__ */ (0, import_jsx_runtime27.jsx)(import_framer_motion13.AnimatePresence, { children: badge !== void 0 && /* @__PURE__ */ (0, import_jsx_runtime27.jsx)(
    ...
    label && /* @__PURE__ */ (0, import_jsx_runtime27.jsx)("span", { id: navID, className: "skc-nav-bar-item__label", children: label })
  ] });
  return (
    // Render with `element` if defined
    Element ? /* @__PURE__ */ (0, import_jsx_runtime27.jsx)(Element, __spreadProps(__spreadValues({}, props), { children: content })) : (
      // Otherwise, render an `<a>`
      /* @__PURE__ */ (0, import_jsx_runtime27.jsx)("a", __spreadProps(__spreadValues({}, props), { children: content }))
    )
  );
}
...
function NavDrawer({
  ...
  const injectedChildren = (
    ...
    React16.Children.map(
      children,
      (section) => React16.cloneElement(section, {
        children: (
          ...
          React16.Children.map(
            ...
            (item) => React16.cloneElement(item, { onClick: onClose })
          )
        )
      })
    )
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime28.jsx)(import_framer_motion14.AnimatePresence, { children: open && /* @__PURE__ */ (0, import_jsx_runtime28.jsxs)(import_jsx_runtime28.Fragment, { children: [
    /* @__PURE__ */ (0, import_jsx_runtime28.jsx)(
      import_framer_motion14.motion.aside,
      {
        ...
        children: /* @__PURE__ */ (0, import_jsx_runtime28.jsx)("nav", { children: injectedChildren })
      }
    ),
    /* @__PURE__ */ (0, import_jsx_runtime28.jsx)(
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime29.jsxs)(
    "section",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ (0, import_jsx_runtime29.jsx)("ul", { role: "list", children })
      ]
    }
  );
}
...
function NavDrawerItem({
  ...
  const linkRef = React17.useRef(null);
  ...
  const content = /* @__PURE__ */ (0, import_jsx_runtime30.jsxs)(import_jsx_runtime30.Fragment, { children: [
    /* @__PURE__ */ (0, import_jsx_runtime30.jsx)("div", { className: "skc-nav-drawer-item__icon", children: icon }),
    /* @__PURE__ */ (0, import_jsx_runtime30.jsx)("span", { className: "skc-nav-drawer-item__label", children: label }),
    metadata && /* @__PURE__ */ (0, import_jsx_runtime30.jsx)("span", { className: "skc-nav-drawer-item__metadata", children: metadata }),
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime30.jsx)("li", { children: Element ? /* @__PURE__ */ (0, import_jsx_runtime30.jsx)(Element, __spreadProps(__spreadValues({}, props), { children: content })) : /* @__PURE__ */ (0, import_jsx_runtime30.jsx)("a", __spreadProps(__spreadValues({}, props), { children: content })) });
}
...
function FAB({
  ...
  const { duration, easing } = useAnimationConfig();
  const fabRef = React18.useRef(null);
  const { rippleListeners, rippleControls, rippleStyle } = useRipple(fabRef);
  const { scrollDir } = useScrollDirection();
  const [canHide, setCanHide] = React18.useState(false);
  React18.useEffect(() => {
    if (stateOnScroll) {
  ...
  const content = /* @__PURE__ */ (0, import_jsx_runtime31.jsx)(import_framer_motion16.AnimatePresence, {
    initial: false,
    // Hide the FAB on scroll if `stateOnScroll` set to `disappear`
    children: !(stateOnScroll === "disappear" && canHide && scrollDir === "down") && /* @__PURE__ */ (0, import_jsx_runtime31.jsxs)(
      import_framer_motion16.motion.div,
      {
        ...
        children: [
          icon && /* @__PURE__ */ (0, import_jsx_runtime31.jsx)("div", { className: "skc-fab__icon", children: icon }),
          // Hide the label on scroll if `stateOnScroll` set to `minimize`
          !(stateOnScroll === "minimize" && !(scrollDir === "up")) && children && /* @__PURE__ */ (0, import_jsx_runtime31.jsx)("span", { className: "skc-fab__label", children }),
  ...
  return (
    // Render with `element` if defined
    href && Element ? /* @__PURE__ */ (0, import_jsx_runtime31.jsx)(Element, __spreadProps(__spreadValues({}, props), { href, children: content })) : (
      // Render an `<a>` if link passed in
      href ? /* @__PURE__ */ (0, import_jsx_runtime31.jsx)("a", __spreadProps(__spreadValues({ href }, props), { children: content })) : (
        // Otherwise, render a `<button>`
        /* @__PURE__ */ (0, import_jsx_runtime31.jsx)("button", __spreadProps(__spreadValues({ type: "button", onClick }, props), { children: content }))
      )
    )
  );
}
...
function ContentLayout({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime32.jsx)(
    import_framer_motion17.motion.main,
    {
      ...
      children: /* @__PURE__ */ (0, import_jsx_runtime32.jsx)("div", { className: "skc-content-layout__content", children })
    }
  );
}
...
function RootLayout({ children, className, style }) {
  let content;
  const persistentComponents = React19.Children.map(children, (child) => {
    if (child == null ? void 0 : child.type.displayName)
      return child;
    else
      content = child;
  });
  return /* @__PURE__ */ (0, import_jsx_runtime33.jsxs)("div", { style, className: cn(["skc-root-layout", className]), children: [
...
function PageHeader({
  ...
  const [minimized, setMinimized] = React20.useState(false);
  React20.useEffect(() => {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime34.jsxs)(import_jsx_runtime34.Fragment, { children: [
    /* @__PURE__ */ (0, import_jsx_runtime34.jsx)("div", { className: "skc-page-header__replacement-color" }),
    ...
    /* @__PURE__ */ (0, import_jsx_runtime34.jsx)(import_framer_motion19.LayoutGroup, { children: /* @__PURE__ */ (0, import_jsx_runtime34.jsx)(
      import_framer_motion19.motion.header,
      {
        ...
        children: /* @__PURE__ */ (0, import_jsx_runtime34.jsxs)("div", { className: "skc-page-header__content", children: [
          icon && !children && /* @__PURE__ */ (0, import_jsx_runtime34.jsx)(
            ...
            import_framer_motion19.motion.div,
            {
              ...
              children: [
                /* @__PURE__ */ (0, import_jsx_runtime34.jsx)(
                  ...
                  {
                    appearance: "text",
                    icon: /* @__PURE__ */ (0, import_jsx_runtime34.jsx)(MaterialIcon, { icon: "arrow_backward" }),
                ...
                /* @__PURE__ */ (0, import_jsx_runtime34.jsx)(import_framer_motion19.motion.h1, __spreadProps(__spreadValues({}, headerTextProps), { children: title })),
                /* @__PURE__ */ (0, import_jsx_runtime34.jsxs)("div", { className: "skc-page-header__trailing", children: [
                  homeURL && // Home Button
                  /* @__PURE__ */ (0, import_jsx_runtime34.jsx)(
                    Button,
                    __spreadValues({
                      appearance: "text",
                      icon: brand || /* @__PURE__ */ (0, import_jsx_runtime34.jsx)(MaterialIcon, { icon: "home" }),
                      href: homeURL,
                      element
                    }, backAttr)
                  ),
                  /* @__PURE__ */ (0, import_jsx_runtime34.jsx)(
                    ...
                    {
                      appearance: "text",
                      icon: /* @__PURE__ */ (0, import_jsx_runtime34.jsx)(MaterialIcon, { icon: "menu" }),
                      onClick: onNavToggle
                    }
                  )
                ] })
...
function Radio({
  ...
  const rippleParentRef = React21.useRef(null);
  const { rippleListeners, rippleControls, rippleStyle } = useRipple(rippleParentRef);
  return /* @__PURE__ */ (0, import_jsx_runtime35.jsxs)(
    ...
    __spreadProps(__spreadValues({
      ...
      children: [
        ...
        /* @__PURE__ */ (0, import_jsx_runtime35.jsx)("div", { "aria-hidden": true, className: "skc-radio__circle", children: /* @__PURE__ */ (0, import_jsx_runtime35.jsx)("div", { className: "skc-radio__marker" }) }),
        /* @__PURE__ */ (0, import_jsx_runtime35.jsx)(
          "div",
          {
            ref: rippleParentRef,
...
function Switch({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime37.jsx)(
    ...
    __spreadProps(__spreadValues({
      ...
      children: /* @__PURE__ */ (0, import_jsx_runtime37.jsx)("div", { className: "skc-switch__handle", children: value ? onIcon : offIcon })
    })
  );
}
...
function TextField({
  ...
  const { duration, easing } = useAnimationConfig();
  const labelControls = (0, import_framer_motion21.useAnimationControls)();
  const trailingControls = (0, import_framer_motion21.useAnimationControls)();
  const [minifyLabel, setMinifyLabel] = React23.useState();
  const [neverResetLabel, setNeverMinifyLabel] = React23.useState(false);
  ...
  React23.useEffect(() => expandTextarea, [value]);
  const [error, setError] = React23.useState(false);
  React23.useEffect(() => setError(Boolean(incError)), [incError]);
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime38.jsxs)(
    "label",
    {
      ...
      children: [
        ...
        leading && /* @__PURE__ */ (0, import_jsx_runtime38.jsx)(import_framer_motion21.motion.div, { className: "skc-text-field__leading", children: leading }),
        behavior === "single-line" ? /* @__PURE__ */ (0, import_jsx_runtime38.jsx)("input", __spreadValues(__spreadValues({}, inputProps), inputAttr)) : /* @__PURE__ */ (0, import_jsx_runtime38.jsx)("textarea", __spreadValues({ ref: textareaRef }, inputProps)),
        /* @__PURE__ */ (0, import_jsx_runtime38.jsx)(import_framer_motion21.LayoutGroup, { children: /* @__PURE__ */ (0, import_jsx_runtime38.jsxs)(import_framer_motion21.AnimatePresence, { initial: false, children: [
          trailing && /* @__PURE__ */ (0, import_jsx_runtime38.jsx)(
          ...
          (canClear || error) && /* @__PURE__ */ (0, import_jsx_runtime38.jsx)(
            import_framer_motion21.motion.div,
            {
              ...
              transition: fieldTransition,
              className: "skc-text-field__trailing",
              children: canClear ? /* @__PURE__ */ (0, import_jsx_runtime38.jsx)(
                Button,
                {
                  appearance: "text",
                  icon: /* @__PURE__ */ (0, import_jsx_runtime38.jsx)(MaterialIcon, { icon: "cancel" }),
                  disabled,
                  onClick: () => onChange && onChange("")
                }
              ) : error ? /* @__PURE__ */ (0, import_jsx_runtime38.jsx)(MaterialIcon, { icon: "error", fill: true }) : null
            }
          )
        ] }) }),
        helperMsg && /* @__PURE__ */ (0, import_jsx_runtime38.jsx)("span", { id: `${fieldID}-helper`, className: "skc-text-field__helper-msg", children: helperMsg })
      ]
    }
  );
}
